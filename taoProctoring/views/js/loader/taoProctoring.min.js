...
;return buffer+="<h1>",stack1=(helper=helpers.title)||typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h1>"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n    <div class="panel"></div>\n    <div class="list clearfix"></div>\n</div>'})}),define("tpl!taoProctoring/templates/delivery/listBoxActions",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",escapeExpression=this.escapeExpression,
helperMissing=helpers.helperMissing;return buffer+='<span class="listbox-actions">\n    <span class="action pause" data-delivery="',buffer+=escapeExpression((helper=helpers.id)||"function"==typeof(helper=depth0&&depth0.id)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n        <span class="icon-pause"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Pause",options):helperMissing.call(depth0,"__","Pause",options)))+'\n    </span>\n    <span class="action play">\n        <span class="icon-play"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__
...
;return buffer+='\n<ul class="plain listbox-properties">\n    <li>\n        <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Start",options):helperMissing.call(depth0,"__","Start",options)))+"</label>: ",stack1=(helper=helpers.periodStart)||typeof(helper=depth0&&depth0.periodStart)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"\n    </li>\n    <li>\n        <label>"+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"End",options):helperMissing.call(depth0,"__","End",options)))+"</label>: ",
stack1=(helper=helpers.periodEnd)||typeof(helper=depth0&&depth0.periodEnd)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"\n    </li>\n</ul>\n"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n<p class="listbox-stats">\n    <span class="icon-lock"></span><span class="number">',stack1=(helper=helpers.locked)||typeof(helper=depth0&&depth0.locked)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</span>\n    <span class="icon-play"></span><span class="number">',stack1=(helper=helpers.inProgress)||typeof(helper=depth0&&depth0.inProgress
)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</span>\n    <span class="icon-pause"></span><span class="number">',stack1=(helper=helpers.paused)||typeof(helper=depth0&&depth0.paused)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span>\n</p>"})}),define("taoProctoring/controller/Delivery/index",["jquery","lodash","i18n","module","core/promise","controller/app","util/url","layout/loading-bar","ui/listbox","util/encode","ui/feedback","ui/bulkActionPopup","ui/cascadingComboBox","ui/container","taoProctoring/helper/status","taoProctoring/component/proxy",
"tpl!taoProctoring/templates/delivery/index","tpl!taoProctoring/templates/delivery/listBoxActions","tpl!taoProctoring/templates/delivery/listBoxStats","util/locale"],function($,_,__,module,Promise,appController,urlHelper,loadingBar,listBoxFactory,encode,feedback,bulkActionPopup,cascadingComboBox,containerFactory,_status,proxyFactory,indexTpl,actionsTpl,statsTpl,locale){"use strict";var serviceUrl=urlHelper.route("deliveries","DeliverySelection","taoProctoring"),pauseUrl=urlHelper.route("pauseExecutions","Monitor","taoProctoring"),sessionsUrl=urlHelper.route("deliveryExecutions","Monitor","taoProctoring");function validateParams(params){
return _.isPlainObject(params)&&(_.isUndefined(params.delivery)||!_.isEmpty(params.delivery))&&(_.isUndefined(params.execution)||!_.isEmpty(params.execution))&&(_.isUndefined(params.reason)||!_.isEmpty(params.reason))}return loadingBar.start(),{start:function(){var deliveries,categories,proxyDeliveries,proxySessions,title=__("Sessions"),context=module.config().context,container=containerFactory(".container").changeScope(".delivery-index").write(indexTpl({title:title})),listBox=listBoxFactory({title:title,textEmpty:__("No sessions available"),textNumber:__("Available"),textLoading:__("Loading"),renderTo:container.find(".content"),replace:!0,list:[],width:12,
countRenderer:function(count){return count-1}});appController.on("change.deliveryIndex",function(){appController.off(".deliveryIndex"),listBox.destroy(),container.destroy()}),Promise.all([proxyFactory("ajax").init({actions:{read:serviceUrl}}).then(function(proxy){proxyDeliveries=proxy}),proxyFactory("ajax").init({actions:{read:{url:sessionsUrl,validate:validateParams},pause:{url:pauseUrl,validate:validateParams}}}).then(function(proxy){proxySessions=proxy})]).then(function(){function getDeliveryLabel(id){return deliveries[id]&&deliveries[id].label}function refresh(){return loadingBar.start(),listBox.setLoading(!0),proxyDeliveries.read({context:context}
).then(function(data){categories=data.categories,deliveries=_.transform(data.list,function(result,delivery){var props=delivery.properties,tplData={locked:delivery.stats.awaitingApproval,inProgress:delivery.stats.inProgress,paused:delivery.stats.paused};props&&props.periodStart&&props.periodEnd&&(tplData.showProperties=!0,tplData.periodStart=props.periodStart,tplData.periodEnd=props.periodEnd,delivery.cls="has-properties-displayed"),delivery.html=actionsTpl({id:delivery.id}),delivery.content=statsTpl(tplData),delivery.cls=((delivery.cls||"")+" router").trim(),result[delivery.id]=delivery},{}),listBox.update(data.list),loadingBar.stop()}).catch(function(err){
appController.onError(err)})}function pause(deliveryId,selection,deliveryExecutions){return new Promise(function(resolve,reject){var sessions;bulkActionPopup({renderTo:container.getElement(),actionName:__("Pause Session"),reason:!0,resourceType:"session",categoriesSelector:cascadingComboBox({categoriesDefinitions:categories.pause.categoriesDefinitions,categories:categories.pause.categories}),allowedResources:(sessions=selection,_.map(sessions,function(session){return{id:session.id,label:session.delivery.label+" ["+locale.formatDateTime(session.start_time)+"]"}}))}).on("cancel",resolve).on("ok",function(reason){proxySessions.action("pause",{
delivery:deliveryId,execution:_.pluck(selection,"id"),reason:reason}).then(function(){feedback().success("Selected deliveries successfully paused"),refresh().then(resolve).catch(reject)}).catch(function(err){err.response?(feedback().warning(__("Something went wrong ...")+"<br>"+function(response,deliveryExecutions){var messageContext,unprocessed,responseData;return messageContext="",response&&(responseData=response.data,unprocessed={},responseData&&_.forEach(responseData.unprocessed,function(id){var execution=deliveryExecutions[id],uri=execution&&execution.delivery&&execution.delivery.uri;uri&&(unprocessed[uri]=(unprocessed[uri]||0)+1)}),(unprocessed=_.map(
unprocessed,function(count,uri){return 1<count?__("%d sessions of the delivery %s have not been paused",count,getDeliveryLabel(uri)):__("A session of the delivery %s have not been paused",getDeliveryLabel(uri))})).length&&(messageContext+="<br>"+unprocessed.join("<br>")),response.error&&(messageContext+="<br>"+encode.html(response.error))),messageContext}(err.response,deliveryExecutions),{encodeHtml:!1}),resolve()):reject(err)})})})}listBox.getElement().on("click",".pause",function(e){var deliveryId=$(this).data("delivery");loadingBar.start(),e.stopPropagation(),e.preventDefault(),proxySessions.read({delivery:deliveryId,context:context}).then(function(
sessions){var inProgressExecs,deliveryExecutions={};if((inProgressExecs=_.filter(sessions,function(session){return(deliveryExecutions[session.id]=session).state&&session.state.status===_status.getStatus("inprogress").code})).length)return pause(deliveryId,inProgressExecs,deliveryExecutions);feedback().info(__("There is no delivery in progress"))}).catch(function(err){appController.onError(err)}).then(function(){loadingBar.stop()})}),refresh()}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/component/breadcrumbs",["ui/breadcrumbs"],function(breadcrumbs){"use strict";return function($container,crumbs){
return breadcrumbs({breadcrumbs:crumbs,renderTo:$container.find(".header"),replace:!0,cls:"action-bar horizontal-action-bar"})}}),define("taoProctoring/controller/Delivery/manage",["jquery","i18n","helpers","layout/loading-bar","util/encode","ui/feedback","ui/dialog","taoProctoring/component/breadcrumbs","ui/datatable"],function($,__,helpers,loadingBar,encode,feedback,dialog,breadcrumbsFactory){"use strict";return loadingBar.start(),{start:function(){function remove(selection){!function(url,selection,message){selection&&selection.length&&(loadingBar.start(),$.ajax({url:url,data:{testtaker:selection},dataType:"json",type:"POST",error:function(){
loadingBar.stop()}}).done(function(response){loadingBar.stop(),response&&response.success?(message&&feedback().success(message),$list.datatable("refresh")):feedback().error(__("Something went wrong ...")+"<br>"+encode.html(response.error),{encodeHtml:!1})}))}(removeUrl,selection,__("Test takers have been removed"))}var $container=$(".delivery-manager"),$list=$container.find(".list"),crumbs=$container.data("breadcrumbs"),dataset=$container.data("set"),deliveryId=$container.data("delivery"),testCenterId=$container.data("testcenter"),assignUrl=helpers._url("testTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),
removeUrl=helpers._url("removeTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),serviceUrl=helpers._url("deliveryTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),monitoringUrl=helpers._url("monitoring","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId});breadcrumbsFactory($container,crumbs);$list.on("query.datatable",function(){loadingBar.start()}).on("load.datatable",function(){loadingBar.stop()}).datatable({url:serviceUrl,status:{empty:__("No assigned test takers"),available:__("Assigned test takers"),loading:__("Loading")},tools:[{id:"refresh",icon:"reset",
title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}},{id:"back",icon:"preview",title:__("Return to the session monitoring"),label:__("Monitoring"),action:function(){window.location.href=monitoringUrl}},{id:"assign",icon:"add",title:__("Assign more test takers to this session"),label:__("Add test takers"),action:function(){window.location.href=assignUrl}},{id:"remove",icon:"remove",title:__("Remove the selected test takers from the session"),label:__("Remove"),massAction:!0,action:function(selection){dialog({message:__("The test takers will be removed from this session. Continue ?"),autoRender:!0,autoDestroy:!0,
onOkBtn:function(){remove(selection)}})}}],actions:[{id:"remove",icon:"remove",title:__("Remove the test taker from the session"),action:function(id){dialog({autoRender:!0,autoDestroy:!0,message:__("The test taker will be removed from this session. Continue ?"),onOkBtn:function(){remove([id])}})}}],selectable:!0,model:[{id:"firstname",label:__("First name")},{id:"lastname",label:__("Last name")},{id:"identifier",label:__("Identifier")},{id:"status",label:__("Status")}]},dataset)}}}),define("taoProctoring/component/extraTime/encoder",["core/format","core/encoder/time"],function(format,timeEncoder){"use strict";return function(extraTime,consumedTime,pattern,
unit){var encoded="";return pattern=pattern||"%s",unit=unit||1,extraTime&&(encoded=" +"+(encoded=consumedTime?timeEncoder.encode(Math.min(consumedTime,extraTime))+"/"+timeEncoder.encode(extraTime):"HH:mm:ss"===pattern?timeEncoder.encode(extraTime):format(pattern,extraTime/unit))),encoded}}),define("tpl!taoProctoring/component/extraTime/extraTime",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this,
helperMissing=helpers.helperMissing;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='\n            <li data-resource="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n                <span class="resource-label">',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span>\n                ",!(stack1=helpers.if.call(depth0,depth0&&depth0.remainingStr,{hash:{},inverse:self.noop,fn:self.program(3,program3,data),
data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                ",!(stack1=helpers.if.call(depth0,depth0&&depth0.extraTimeStr,{hash:{},inverse:self.noop,fn:self.program(5,program5,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n            </li>\n            "}function program3(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="remaining">',stack1=(helper=helpers.remainingStr)||typeof(helper=depth0&&depth0.remainingStr)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span>"}function program5(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="time">(',
stack1=(helper=helpers.extraTimeStr)||typeof(helper=depth0&&depth0.extraTimeStr)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+")</span>"}function program7(depth0,data){var stack1,helper,options,buffer="";return buffer+="\n    <p>"+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"However, the action will not be applied to the following sessions",options):helperMissing.call(depth0,"__","However, the action will not be applied to the following sessions",options)))+':</p>\n    <ul class="plain no-applicables">\n        ',!(stack1=helpers.each.call(depth0,
depth0&&depth0.deniedResources,{hash:{},inverse:self.noop,fn:self.program(8,program8,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n    </ul>\n    "}function program8(depth0,data){var stack1,helper,buffer="";return buffer+='\n        <li data-resource="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n            <span class="resource-label">',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+'</span>\n            <span class="reason">(',stack1=(helper=helpers.reason)||typeof(helper=depth0&&depth0.reason)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+")</span>\n        </li>\n        "}return buffer+='<div class="bulk-action-popup">\n    <h2 class="title">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Action",options):helperMissing.call(depth0,"__","Action",options)))+": ",stack1=(helper=helpers.actionName)||typeof(helper=depth0&&depth0.actionName)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(
...
action:function(){var elapsed=timer.tick()/1e3,timers=$(".procotor-timer_time.countDown");_.forEach(timers,function(timerItem){var remaining=$(timerItem).data("remaining");0<remaining&&(remaining-=elapsed,$(timerItem).html(timeEncoder.encode(Math.round(remaining))),$(timerItem).data("remaining",remaining))})},interval:1e3,autoStart:!1});appController.on("change.deliveryMonitoring",function(){appController.off(".deliveryMonitoring"),container.destroy()}),proxyFactory("ajax").init({actions:{read:serviceUrl,authorize:{url:authorizeUrl,validate:validateParams},pause:{url:pauseUrl,validate:validateParams},terminate:{url:terminateUrl,validate:validateParams},
...
),result},customFilter:{template:'<input type="text" id="start_time_filter" name="filter[start_time]"/><button class="icon-find js-start_time_filter_button" type="button"></button>',callback:function($el){var comparisonDateFormat,dateFormat=locale.getDateTimeFormat().split(" "),dateFormatStr=dateFormat[0];dateFormatStr=(dateFormatStr=(dateFormatStr=dateFormatStr.replace("YYYY","yy")).replace("MM","mm")).replace("DD","dd"),comparisonDateFormat=dateFormat[0],$el.datepicker({dateFormat:dateFormatStr,onSelect:function(selectedDate){var datePickerData=$(this).data().datepicker;datePickerData.first?(moment(datePickerData.first,comparisonDateFormat).format("X"
)<moment(selectedDate,comparisonDateFormat).format("X")?$(this).val(datePickerData.first+" - "+selectedDate):$(this).val(selectedDate+" - "+datePickerData.first),datePickerData.inline=!1,$(".js-start_time_filter_button").trigger("click")):(datePickerData.inline=!0,datePickerData.first=selectedDate)},onClose:function(event){event.which===$.ui.keyCode.ENTER&&(event.preventDefault(),$el.datepicker("hide"))}})}}}),model.push({id:"status",label:__("Status"),sortable:!0,filterable:!0,customFilter:{template:statusFilterTpl({statuses:_status.getStatuses()}),callback:statusFilterHandler},transform:function(value,row){var status,result=""
...
"tpl!taoProctoring/templates/deliveryServer/authorizationSuccess",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<span class="success-message">',buffer+=(0,this.escapeExpression)((helper=helpers.message)||"function"==typeof(helper=depth0&&depth0.message)?helper.call(depth0,{hash:{},data:data}):helper)+'<span class="icon-result-ok"></span></span>'})}),define("tpl!taoProctoring/templates/deliveryServer/authorizationListBoxActions",["handlebars"],function(hb){return hb.template(
function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<span class="listbox-actions">\n    ',!(stack1=helpers.if.call(depth0,depth0&&depth0.cancelable,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <span class="action cancel js-cancel">\n        <span class="icon-stop"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,
"Cancel",options):helperMissing.call(depth0,"__","Cancel",options)))+"\n    </span>\n    "},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n    <span class="action play js-proceed" data-delivery="',stack1=(helper=helpers.id)||"function"==typeof(helper=depth0&&depth0.id)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n        <span class="icon-play"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Proceed",options):helperMissing.call(depth0,"__","Proceed",options)))+"\n    </span>\n</span>"})}),define(
...
)+'</label><input type="text" name="periodStart" value="',buffer+=escapeExpression((helper=helpers.start)||"function"==typeof(helper=depth0&&depth0.start)?helper.call(depth0,{hash:{},data:data}):helper)+'"/>\n    <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"to",options):helperMissing.call(depth0,"__","to",options)))+'</label><input type="text" name="periodEnd" value="',buffer+=escapeExpression((helper=helpers.end)||"function"==typeof(helper=depth0&&depth0.end)?helper.call(depth0,{hash:{},data:data}):helper
...
$.datepicker.parseTime=function(timeFormat,timeString,options){function strictParse(f,s,o){var treg,regstr="^"+f.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(match){var amNames,pmNames,markers,ml=match.length;switch(match.charAt(0).toLowerCase()){case"h":case"m":case"s":return 1===ml?"(\\d?\\d)":"(\\d{"+ml+"})";case"l":case"c":return"(\\d?\\d?\\d)";case"z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case"t":return amNames=o.amNames,pmNames=o.pmNames,markers=[],amNames&&$.merge(markers,amNames),pmNames&&$.merge(markers,pmNames),"("+(markers=$.map(markers,function(val){return val.replace(/[.*+?|()\[\]{}\\]/g,"\\$&")})).join("|")+")?"
;default:return"("+match.replace(/\'/g,"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(m){return"\\"+m})+")?"}}).replace(/\s/g,"\\s?")+o.timeSuffix+"$",order=function(timeFormat){var finds=timeFormat.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g),orders={h:-1,m:-1,s:-1,l:-1,c:-1,t:-1,z:-1};if(finds)for(var i=0;i<finds.length;i++)-1==orders[finds[i].toString().charAt(0)]&&(orders[finds[i].toString().charAt(0)]=i+1);return orders}(f),ampm="",resTime={hour:0,minute:0,second:0,millisec:0,microsec:0};return!!(treg=s.match(new RegExp(regstr,"i")))&&(-1!==order.t&&(void 0===treg[order.t]||0===treg[order.t].length?(ampm="",
resTime.ampm=""):(ampm=-1!==$.inArray(treg[order.t].toUpperCase(),o.amNames)?"AM":"PM",resTime.ampm=o["AM"==ampm?"amNames":"pmNames"][0])),-1!==order.h&&("AM"==ampm&&"12"==treg[order.h]?resTime.hour=0:"PM"==ampm&&"12"!=treg[order.h]?resTime.hour=parseInt(treg[order.h],10)+12:resTime.hour=Number(treg[order.h])),-1!==order.m&&(resTime.minute=Number(treg[order.m])),-1!==order.s&&(resTime.second=Number(treg[order.s])),-1!==order.l&&(resTime.millisec=Number(treg[order.l])),-1!==order.c&&(resTime.microsec=Number(treg[order.c])),-1!==order.z&&void 0!==treg[order.z]&&(resTime.timezone=$.timepicker.timezoneOffsetNumber(treg[order.z])),resTime)}var o=extendRemove(
...
).toLowerCase();return{hour:isIn(tf,"h"),minute:isIn(tf,"m"),second:isIn(tf,"s"),millisec:isIn(tf,"l"),microsec:isIn(tf,"c"),timezone:isIn(tf,"z"),ampm:isIn("t")&&isIn(timeFormat,"h"),iso8601:isIn(timeFormat,"Z")}},convert24to12=function(hour){return 12<hour&&(hour-=12),0===hour&&(hour=12),String(hour)},splitDateTime=function(dateFormat,dateTimeString,dateSettings,timeSettings){try{var separator=timeSettings&&timeSettings.separator?timeSettings.separator:$.timepicker._defaults.separator,timePartsLen=(timeSettings&&timeSettings.timeFormat?timeSettings.timeFormat:$.timepicker._defaults.timeFormat).split(separator).length,allParts=dateTimeString.split(separator
),allPartsLen=allParts.length;if(1<allPartsLen)return[allParts.splice(0,allPartsLen-timePartsLen).join(separator),allParts.splice(0,timePartsLen).join(separator)]}catch(err){if($.timepicker.log("Could not split the date from the time. Please check the following datetimepicker options\nthrown error: "+err+"\ndateTimeString"+dateTimeString+"\ndateFormat = "+dateFormat+"\nseparator = "+timeSettings.separator+"\ntimeFormat = "+timeSettings.timeFormat),0<=err.indexOf(":")){var dateStringLength=dateTimeString.length-(err.length-err.indexOf(":")-2);dateTimeString.substring(dateStringLength);return[$.trim(dateTimeString.substring(0,dateStringLength)),$.trim(
dateTimeString.substring(dateStringLength))]}throw err}return[dateTimeString,""]},parseDateTimeInternal=function(dateFormat,timeFormat,dateTimeString,dateSettings,timeSettings){var date,splitRes=splitDateTime(dateFormat,dateTimeString,dateSettings,timeSettings);if(date=$.datepicker._base_parseDate(dateFormat,splitRes[0],dateSettings),""===splitRes[1])return{date:date};var timeString=splitRes[1],parsedTime=$.datepicker.parseTime(timeFormat,timeString,timeSettings);if(null===parsedTime)throw"Wrong time format";return{date:date,timeObj:parsedTime}},selectLocalTimezone=function(tp_inst,date){if(tp_inst&&tp_inst.timezone_select){
...
periodEnd:this.getEnd()})}),buttonFactory({id:"back",type:"info",label:__("Back to sessions"),cls:"back-button",renderTo:container.find(".panel")}).on("click",function(){monitoringUrl?appController.getRouter().redirect(monitoringUrl):history.go(-1)})})}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/controller/routes",{Reporting:{actions:{index:"controller/Reporting/history"}},Irregularity:{actions:{index:"controller/Irregularity/index"}},DeliverySelection:{actions:{index:"controller/Delivery/index"}},Monitor:{actions:{index:"controller/Delivery/monitoring"}},Tools:{css:"tools",actions:{
assessmentActivity:"controller/Tools/assessmentActivity"}}}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="col-',buffer+=escapeExpression((helper=helpers.size)||"function"==typeof(helper=depth0&&depth0.size)?helper.call(depth0,{hash:{},data:data}):helper)+' dashboard-block">\n        <span class="dashboard-block-number ',
buffer+=escapeExpression((helper=helpers.container)||"function"==typeof(helper=depth0&&depth0.container)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n            ',buffer+=escapeExpression((helper=helpers.value)||"function"==typeof(helper=depth0&&depth0.value)?helper.call(depth0,{hash:{},data:data}):helper)+'\n        </span>\n    <h3>\n        <span class="icon icon-test-',buffer+=escapeExpression((helper=helpers.icon)||"function"==typeof(helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n        ',buffer+=escapeExpression((helper=helpers.label)||"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,
...
container:"paused-assessments",label:__("Paused"),value:0}}};return function(config){return config=config||{},component({update:function(data){_.merge(this.config.assessments,data),_.each(this.config.assessments,function(val){$("."+val.container,this.getElement()).text(val.value)},this)}},_defaults).setTemplate(tpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/progressbar",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),
...
Promise,url){"use strict";var pendingPromise,labels=null,proctoringLabels={get:function(message){null==labels[message]&&console.log(message);var localized=labels[message]?labels[message]:message;return 1<arguments.length&&(arguments[0]=localized,localized=format.apply(null,arguments)),localized}};return function(){return pendingPromise=pendingPromise||new Promise(function(resolve,reject){$.ajax({url:url.route("getAll","TextConverter","taoProctoring"),type:"POST",dataType:"json"}).done(function(data){labels=data.translations,resolve(proctoringLabels)}).fail(reject)})}}),define("taoProctoring/loader/taoProctoring.bundle",function(){}),window.bundles=(
window.bundles||[]).concat(["taoQtiItem/loader/taoQtiItem.min","taoItems/loader/taoItems.min","taoQtiTest/loader/taoQtiTest.min"]);
