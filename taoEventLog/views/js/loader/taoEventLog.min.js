...
;return buffer+='<div class="log">\n    <div class="grid-row">\n        <div class="col-12">\n            <section class="log-browser">\n                <header>\n                    <h2>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Log watcher",options):helperMissing.call(depth0,"__","Log watcher",options)))+'</h2>\n                    <div class="header-buttons">\n                        <button class="btn-info export js-export"><span class="icon-export"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Export log entries",options
):helperMissing.call(depth0,"__","Export log entries",options)))+'</button>\n                    </div>\n                </header>\n                <div class="log-table-filters"></div>\n                <div class="log-table"></div>\n            </section>\n        </div>\n        <div class="col-5">\n            <section class="event-viewer hidden">\n                <div class="grid-row">\n                    <div class="col-10">\n                        <h3>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Event",options):helperMissing.call(depth0,"__","Event",options))
)+' #<span class="id"></span></h3>\n                    </div>\n                </div>\n\n                ',!(stack1=helpers.each.call(depth0,depth0&&depth0.dataTypes,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+='\n\n                    <div class="grid-row">\n                        <div class="col-12">\n                            <strong>',stack1=(helper=helpers.title)||typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+'</strong>\n                        </div>\n                    </div>\n                    <div class="grid-row">\n                        <div class="col-10 desc">\n                            <span class="',stack1=(helper=helpers.key)||typeof(helper=depth0&&depth0.key)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span>\n                        </div>\n                    </div>\n\n                '},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n\n            </section>\n        </div>\n    </div>\n</div>"})}),define("tpl!taoEventLog/components/export/templates/layout",["handlebars"],
function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="mp-export-modal">\n    <h1>',buffer+=escapeExpression((helper=helpers.title)||"function"==typeof(helper=depth0&&depth0.title)?helper.call(depth0,{hash:{},data:data}):helper)+'</h1>\n    <form class="grid-row js-export-form">\n        <div class="col-12">\n            <h2>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__
)?helper.call(depth0,"CSV Options",options):helperMissing.call(depth0,"__","CSV Options",options)))+'</h2>\n            <div class="grid-row">\n                <label class="col-5" for="field_delimiter">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Field delimiter",options):helperMissing.call(depth0,"__","Field delimiter",options)))+'</label>\n                <input class="col-7" name="field_delimiter" id="field_delimiter" size="2" value=";" type="text">\n            </div>\n            <div class="grid-row">\n                <label class="col-5" for="field_encloser">'+escapeExpression((options={
hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Field encloser",options):helperMissing.call(depth0,"__","Field encloser",options)))+'</label>\n                <input class="col-7" name="field_encloser" size="2" value=\'"\' type="text">\n            </div>\n            <div class="grid-row">\n                <label class="col-5" for="multi_values_delimiter">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Multiple values delimiter",options):helperMissing.call(depth0,"__","Multiple values delimiter",options))
)+'</label>\n                <input class="col-7" name="multi_values_delimiter" size="2" value=\'|\' type="text">\n            </div>\n            <label class="grid-row">\n                <div class="col-5">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"First row column names",options):helperMissing.call(depth0,"__","First row column names",options))
)+'</div>\n                <div class="col-7">\n                    <input type="checkbox" name="first_row_column_names" checked>\n                    <span class="icon-checkbox"></span>\n                </div>\n            </label>\n            <button type="submit" class="btn-success"><span class="icon-upload"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Export",options):helperMissing.call(depth0,"__","Export",options)))+"</button>\n        </div>\n    </form>\n</div>"})}),define("taoEventLog/components/export/exporter",["jquery","lodash","i18n","ui/component","ui/feedback",
"layout/loading-bar","tpl!taoEventLog/components/export/templates/layout","util/url","layout/logout-event","jquery.fileDownload"],function($,_,__,component,feedback,loadingBar,layoutTpl,url,logoutEvent){"use strict";return function(options){if(!_.isPlainObject(options)||!_.isString(options.exportUrl))throw new TypeError("The exporter must be configured with exportUrl option");return component({},{title:__("Export")}).setTemplate(layoutTpl).on("render",function(){var self=this,$form=self.$component.find(".js-export-form");$form.on("submit",function(e){e.preventDefault(),loadingBar.start();var exportUrl,params={};_.each($form.serializeArray(),function(param){
params[param.name]=param.value}),exportUrl=url.build(options.exportUrl,params),$.fileDownload(exportUrl,{successCallback:function(){loadingBar.stop(),self.$component.modal("close")},failCallback:function(jqXHR){loadingBar.stop();var response=$.parseJSON($(jqXHR).text());response?feedback().error(new Error(response.message)):(self.$component.modal("close"),logoutEvent())}})})}).init(options)}}),define("taoEventLog/components/export/modalExporter",["jquery","lodash","i18n","ui/feedback","taoEventLog/components/export/exporter","ui/modal"],function($,_,__,feedback,exporter){"use strict";return function(options){var feedbackOptions={timeout:{warning:8e3},
...
],timeFormat:"HH:mm",timeSuffix:"",timeOnlyTitle:"Choose Time",timeText:"Time",hourText:"Hour",minuteText:"Minute",secondText:"Second",millisecText:"Millisecond",microsecText:"Microsecond",timezoneText:"Time Zone",isRTL:!1},this._defaults={showButtonPanel:!0,timeOnly:!1,showHour:null,showMinute:null,showSecond:null,showMillisec:null,showMicrosec:null,showTimezone:null,showTime:!0,stepHour:1,stepMinute:1,stepSecond:1,stepMillisec:1,stepMicrosec:1,hour:0,minute:0,second:0,millisec:0,microsec:0,timezone:null,hourMin:0,minuteMin:0,secondMin:0,millisecMin:0,microsecMin:0,hourMax:23,minuteMax:59,secondMax:59,millisecMax:999,microsecMax:999,minDateTime:null,
maxDateTime:null,onSelect:null,hourGrid:0,minuteGrid:0,secondGrid:0,millisecGrid:0,microsecGrid:0,alwaysSetTime:!0,separator:" ",altFieldTimeOnly:!0,altTimeFormat:null,altSeparator:null,altTimeSuffix:null,pickerTimeFormat:null,pickerTimeSuffix:null,showTimepicker:!0,timezoneList:null,addSliderAccess:!1,sliderAccessArgs:null,controlType:"slider",defaultValue:null,parse:"strict"},$.extend(this._defaults,this.regional[""])};$.extend(Timepicker.prototype,{$input:null,$altInput:null,$timeObj:null,inst:null,hour_slider:null,minute_slider:null,second_slider:null,millisec_slider:null,microsec_slider:null,timezone_select:null,hour:0,minute:0,second:0,millisec:0,
microsec:0,timezone:null,hourMinOriginal:null,minuteMinOriginal:null,secondMinOriginal:null,millisecMinOriginal:null,microsecMinOriginal:null,hourMaxOriginal:null,minuteMaxOriginal:null,secondMaxOriginal:null,millisecMaxOriginal:null,microsecMaxOriginal:null,ampm:"",formattedDate:"",formattedTime:"",formattedDateTime:"",timezoneList:null,units:["hour","minute","second","millisec","microsec"],support:{},control:null,setDefaults:function(settings){return extendRemove(this._defaults,settings||{}),this},_newInst:function($input,o){var tp_inst=new Timepicker,inlineSettings={},fns={},overrides,i;for(var attrName in this._defaults)if(this._defaults.hasOwnProperty(
attrName)){var attrValue=$input.attr("time:"+attrName);if(attrValue)try{inlineSettings[attrName]=eval(attrValue)}catch(err){inlineSettings[attrName]=attrValue}}for(i in overrides={beforeShow:function(input,dp_inst){if($.isFunction(tp_inst._defaults.evnts.beforeShow))return tp_inst._defaults.evnts.beforeShow.call($input[0],input,dp_inst,tp_inst)},onChangeMonthYear:function(year,month,dp_inst){tp_inst._updateDateTime(dp_inst),$.isFunction(tp_inst._defaults.evnts.onChangeMonthYear)&&tp_inst._defaults.evnts.onChangeMonthYear.call($input[0],year,month,dp_inst,tp_inst)},onClose:function(dateText,dp_inst){!0===tp_inst.timeDefined&&""!==$input.val(
)&&tp_inst._updateDateTime(dp_inst),$.isFunction(tp_inst._defaults.evnts.onClose)&&tp_inst._defaults.evnts.onClose.call($input[0],dateText,dp_inst,tp_inst)}},overrides)overrides.hasOwnProperty(i)&&(fns[i]=o[i]||null);tp_inst._defaults=$.extend({},this._defaults,inlineSettings,o,overrides,{evnts:fns,timepicker:tp_inst}),tp_inst.amNames=$.map(tp_inst._defaults.amNames,function(val){return val.toUpperCase()}),tp_inst.pmNames=$.map(tp_inst._defaults.pmNames,function(val){return val.toUpperCase()}),tp_inst.support=detectSupport(tp_inst._defaults.timeFormat+(tp_inst._defaults.pickerTimeFormat?tp_inst._defaults.pickerTimeFormat:"")+(
tp_inst._defaults.altTimeFormat?tp_inst._defaults.altTimeFormat:"")),"string"==typeof tp_inst._defaults.controlType?("slider"==tp_inst._defaults.controlType&&void 0===jQuery.ui.slider&&(tp_inst._defaults.controlType="select"),tp_inst.control=tp_inst._controls[tp_inst._defaults.controlType]):tp_inst.control=tp_inst._defaults.controlType;var timezoneList=[-720,-660,-600,-570,-540,-480,-420,-360,-300,-270,-240,-210,-180,-120,-60,0,60,120,180,210,240,270,300,330,345,360,390,420,480,525,540,570,600,630,660,690,720,765,780,840];null!==tp_inst._defaults.timezoneList&&(timezoneList=tp_inst._defaults.timezoneList);var tzl=timezoneList.length,tzi=0,tzv=null;if(
0<tzl&&"object"!=typeof timezoneList[0])for(;tzi<tzl;tzi++)tzv=timezoneList[tzi],timezoneList[tzi]={value:tzv,label:$.timepicker.timezoneOffsetString(tzv,tp_inst.support.iso8601)};return tp_inst._defaults.timezoneList=timezoneList,tp_inst.timezone=null!==tp_inst._defaults.timezone?$.timepicker.timezoneOffsetNumber(tp_inst._defaults.timezone):-1*(new Date).getTimezoneOffset(),tp_inst.hour=tp_inst._defaults.hour<tp_inst._defaults.hourMin?tp_inst._defaults.hourMin:tp_inst._defaults.hour>tp_inst._defaults.hourMax?tp_inst._defaults.hourMax:tp_inst._defaults.hour,
...
$.extend({onClose:function(dateText,inst){checkDates($(this),startTime)},onSelect:function(selectedDateTime){selected($(this),startTime,"maxDate")}},options,options.end)),checkDates(startTime,endTime),selected(startTime,endTime,"minDate"),selected(endTime,startTime,"maxDate"),$([startTime.get(0),endTime.get(0)])},$.timepicker.log=function(err){window.console&&console.log(err)},Date.prototype.getMicroseconds||(Date.microseconds=0,Date.prototype.getMicroseconds=function(){return this.microseconds},Date.prototype.setMicroseconds=function(m){return this.microseconds=m,this}),$.timepicker.version="1.3"}}),define("taoEventLog/controller/TaoEventLog/show",["jquery"
,"i18n","util/url","ui/datatable","tpl!taoEventLog/controller/TaoEventLog/show/layout","taoEventLog/components/export/modalExporter","ui/dateRange"],function($,__,url,datatable,layoutTpl,exporter,dateRangeFactory){"use strict";var listUrl=url.route("search","TaoEventLog","taoEventLog");return{start:function(){var data={dataTypes:[{key:"event_name",title:__("Event Name")},{key:"action",title:__("Action")},{key:"user_id",title:__("User ID")},{key:"user_roles",title:__("User Roles")},{key:"occurred",title:__("Occurred")},{key:"properties",title:__("Properties")}]},$layout=$(layoutTpl(data)),$eventFilter=$(".log-browser .log-table-filters",$layout),$eventList=$(
".log-browser .log-table",$layout),$eventViewer=$(".event-viewer",$layout),$exportLink=$(".js-export",$layout),$filterRange=dateRangeFactory({pickerType:"datetimepicker",renderTo:$eventFilter,pickerConfig:{dateFormat:"yy-mm-dd",timeFormat:"HH:mm:ss"}}),currentFilter={filtercolumns:{}};$filterRange.on("submit",function(){$eventList.datatable("options",{params:{periodStart:$filterRange.getStart(),periodEnd:$filterRange.getEnd()}}),$eventList.datatable("refresh")}),$exportLink.on("click",function(){currentFilter.filtercolumns=_.merge(currentFilter.filtercolumns,{from:$filterRange.getStart(),to:$filterRange.getEnd()}),exporter({title:__("Export Log Entries"),
exportUrl:url.route("export","TaoEventLog","taoEventLog",currentFilter)})}),$(".content").append($layout),$eventList.datatable({url:listUrl,sortby:"occurred",sortorder:"desc",filter:!0,rowSelection:!0,filterStrategy:"multiple",model:[{id:"identifier",label:__("ID"),transform:function(id,row){return row.raw.id}},{id:"event_name",label:__("Event Name"),sortable:!0,filterable:!0},{id:"action",label:__("Action"),sortable:!0,filterable:!0},{id:"user_id",label:__("User ID"),sortable:!0,filterable:!0},{id:"user_roles",label:__("User Roles"),sortable:!0,filterable:!0,transform:function(roles){var roleFiltered,result,rolesArray=roles.split(", "),
rolesCount=rolesArray.length;return 1<rolesCount?result=currentFilter.filtercolumns.user_roles&&(roleFiltered=_.find(rolesArray,function(item){return-1<item.toLowerCase().indexOf(currentFilter.filtercolumns.user_roles.toLowerCase())}))?__("%s and %s roles",roleFiltered,rolesCount-1):__("%s roles",rolesCount):1===rolesCount&&(result=roles),result}},{id:"occurred",label:__("Occurred"),sortable:!0}],listeners:{selected:function(e,event){!function(event){var key,json,str;for(key in event)event.hasOwnProperty(key)&&("properties"===key?(null!==(json=JSON.parse(event[key]))&&"object"!=typeof json&&(json=JSON.parse(json)),str=JSON.stringify(json,void 0,2),$("."+key,
$eventViewer).html("<pre>"+str+"</pre>")):"user_roles"===key?$("."+key,$eventViewer).html(event.user_roles.split(",").join("<br>")):$("."+key,$eventViewer).html(event[key]))}(event.raw),$eventViewer.is(".hidden")&&($layout.find(".col-12").removeClass("col-12").addClass("col-7"),$eventViewer.removeClass("hidden"))},filter:function(e,options){options.page=1},query:function(e,ajaxConfig){currentFilter=_.pick(ajaxConfig&&ajaxConfig.data,["filterquery","filtercolumns","sortby","sortorder","sorttype"])}}})}}}),define("taoEventLog/loader/taoEventLog.bundle",function(){});
