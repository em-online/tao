...
):helperMissing.call(depth0,"__","cancel",options)))+"</a>\n    </div>\n</div>"})}),define("css!taoTestCenterCss/eligibilityEditor",[],function(){}),define("taoTestCenter/component/eligibilityEditor",["jquery","lodash","i18n","module","helpers","uri","ui/component","generis.tree.select","tpl!taoTestCenter/component/eligibilityEditor/layout","ui/feedback","ui/modal","css!taoTestCenterCss/eligibilityEditor"],function($,_,__,module,helpers,uri,component,GenerisTreeSelectClass,layoutTpl,feedback){"use strict";var _ns=".eligibility-editor",_modalDefaults={width:600},config={dataUrl:helpers._url("getData","GenerisTree","tao"),
deliveriesOrder:"http://www.w3.org/2000/01/rdf-schema#label",deliveriesOrderdir:"asc",isDacEnabled:!1,testTakerDataUrl:helpers._url("getData","TestCenterManager","taoTestCenter")};config=_.defaults({},module.config(),config),_.isObject(config.testTakerDataUrl)?config.testTakerDataUrl=helpers._url(config.testTakerDataUrl.action,config.testTakerDataUrl.controller,config.testTakerDataUrl.extension):config.testTakerDataUrl=config.dataUrl;return function(){var eligibilityEditor,testTakerTreeId=_.uniqueId("eligible-testTaker-tree-"),deliveryTreeId=_.uniqueId("eligible-delivery-tree-"),buildTestTakerTree=function(id,url,testTakers){var selected=_.pluck(testTakers,
"uri");return new GenerisTreeSelectClass("#"+id,url,{actionId:"treeOptions.actionId",saveUrl:"treeOptions.saveUrl",saveData:{},checkedNodes:_.map(selected,uri.encode),serverParameters:{openParentNodes:selected,rootNode:"http://www.tao.lu/Ontologies/TAOSubject.rdf#Subject"},paginate:10,checkResourcePermissions:config.isDacEnabled})},destroyModal=function(){eligibilityEditor&&eligibilityEditor.getElement()&&eligibilityEditor.getElement().modal("destroy").remove()},initModal=function(modalConfig){modalConfig=_.defaults(modalConfig||{},_modalDefaults),eligibilityEditor&&eligibilityEditor.getElement()&&eligibilityEditor.getElement().addClass("modal").on(
"closed.modal",destroyModal).modal(modalConfig)};return eligibilityEditor=component({add:function($container,options){return this.on("render",function(){var deliveryTree,testTakerTree,id,url,deliveries,selected,self=this;options=_.defaults(options||{},this.config),id=deliveryTreeId,url=options.dataUrl,selected=_.pluck(deliveries,"uri"),deliveryTree=new GenerisTreeSelectClass("#"+id,url,{actionId:"treeOptions.actionId",saveUrl:"treeOptions.saveUrl",saveData:{},checkedNodes:_.map(selected,uri.encode),serverParameters:{openParentNodes:selected,rootNode:"http://www.tao.lu/Ontologies/TAODelivery.rdf#AssembledDelivery",order:config.deliveriesOrder,
orderdir:config.deliveriesOrderdir},paginate:10}),testTakerTree=buildTestTakerTree(testTakerTreeId,options.testTakerDataUrl),initModal({width:650}),this.$component.on("click"+_ns,".actions .done",function(e){var deliveries=_(deliveryTree.getChecked()).uniq().compact().value(),testTakers=_(testTakerTree.getChecked()).uniq().compact().value();deliveries&&deliveries.length?(self.trigger("ok",{deliveries:deliveries,testTakers:testTakers}),destroyModal()):feedback(self.$component).warning(__("At least one delivery need to be selected to create"))}).on("click"+_ns,".actions .cancel",function(e){e.preventDefault(),destroyModal(),self.trigger("cancel")}),
this.trigger("open")}).init({title:__("Add Eligibility"),editingMode:!1,subjectTreeId:testTakerTreeId,deliveryTreeId:deliveryTreeId}).render($container).resize()},edit:function($container,deliveryName,testTakers,options){return this.on("render",function(){var testTakerTree,self=this;options=_.defaults(options||{},this.config),testTakerTree=buildTestTakerTree(testTakerTreeId,options.testTakerDataUrl,testTakers),initModal({width:400}),this.$component.on("click"+_ns,".actions .done",function(e){var testTakers=_(testTakerTree.getChecked()).uniq().compact().value();self.trigger("ok",{testTakers:testTakers}),destroyModal()}).on("click"+_ns,".actions .cancel",
function(e){e.preventDefault(),destroyModal(),self.trigger("cancel")}),this.trigger("open")}).init({title:__("Edit Eligibility"),editingMode:!0,subjectTreeId:testTakerTreeId,deliveryTreeId:deliveryTreeId,deliveryName:deliveryName}).render($container).resize()},resize:function(){return eligibilityEditor.getElement().css({top:"40px","overflow-y":"auto"}),eligibilityEditor.getElement().css("max-height",$(window).height()-2*parseInt(eligibilityEditor.getElement().css("top"),10)+"px"),this}},config).setTemplate(layoutTpl)}}),define("tpl!taoTestCenter/component/eligibilityTable/status",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,
helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return(stack1=helpers.if.call(depth0,depth0&&depth0.byPassProctor,{hash:{},inverse:this.program(3,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <span class="icon-shield txt-success" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"This delivery needs proctor authorization",options):helperMissing.call(depth0,"__","This delivery needs proctor authorization",options))
)+'"></span>\n'},data),fn:this.program(1,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <span class="icon-unshield txt-danger" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"This delivery can be launched without authorization",options):helperMissing.call(depth0,"__","This delivery can be launched without authorization",options)))+'"></span>\n'},data),data:data}))||0===stack1?stack1:""})}),define("tpl!taoTestCenter/component/eligibilityTable/actions",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,
">= 1.0.0"],data=data||{};var stack1,helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<button class="btn-info small edit" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Edit eligibile test takers",options):helperMissing.call(depth0,"__","Edit eligibile test takers",options)))+'" data-action="edit">\n    <span class="icon-edit"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Edit",options):helperMissing.call(depth0,"__",
"Edit",options)))+"\n</button>\n\n",!(stack1=helpers.if.call(depth0,depth0&&depth0.byPassProctor,{hash:{},inverse:this.program(3,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <button class="btn-info small edit" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Remove proctor authorization",options):helperMissing.call(depth0,"__","Remove proctor authorization",options)))+'" data-action="unshield">\n        <span class="icon-unshield"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Un-Proctor",options
):helperMissing.call(depth0,"__","Un-Proctor",options)))+"\n    </button>\n"},data),fn:this.program(1,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <button class="btn-info small edit" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Enable proctor authorization",options):helperMissing.call(depth0,"__","Enable proctor authorization",options)))+'" data-action="shield">\n        <span class="icon-shield"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Proctor",options):helperMissing.call(depth0,"__",
