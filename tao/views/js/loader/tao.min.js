...
;return lib$es6$promise$asap$$vertxNext=vertx.runOnLoop||vertx.runOnContext,function(){lib$es6$promise$asap$$vertxNext(lib$es6$promise$asap$$flush)}}catch(e){return lib$es6$promise$asap$$useSetTimeout()}}:lib$es6$promise$asap$$useSetTimeout)();var lib$es6$promise$$internal$$PENDING=void 0,lib$es6$promise$$internal$$FULFILLED=1,lib$es6$promise$$internal$$REJECTED=2,lib$es6$promise$$internal$$GET_THEN_ERROR=new lib$es6$promise$$internal$$ErrorObject;function lib$es6$promise$$internal$$handleForeignThenable(promise,thenable,then){lib$es6$promise$asap$$asap(function(promise){var sealed=!1,error=function(then,value,fulfillmentHandler,rejectionHandler){try{
then.call(value,fulfillmentHandler,rejectionHandler)}catch(e){return e}}(then,thenable,function(value){sealed||(sealed=!0,(thenable!==value?lib$es6$promise$$internal$$resolve:lib$es6$promise$$internal$$fulfill)(promise,value))},function(reason){sealed||(sealed=!0,lib$es6$promise$$internal$$reject(promise,reason))},promise._label);!sealed&&error&&(sealed=!0,lib$es6$promise$$internal$$reject(promise,error))},promise)}function lib$es6$promise$$internal$$handleMaybeThenable(promise,maybeThenable){if(maybeThenable.constructor===promise.constructor)!function(promise,thenable){
...
;then===lib$es6$promise$$internal$$GET_THEN_ERROR?lib$es6$promise$$internal$$reject(promise,lib$es6$promise$$internal$$GET_THEN_ERROR.error):void 0!==then&&lib$es6$promise$utils$$isFunction(then)?lib$es6$promise$$internal$$handleForeignThenable(promise,maybeThenable,then):lib$es6$promise$$internal$$fulfill(promise,maybeThenable)}}function lib$es6$promise$$internal$$resolve(promise,value){var x;promise===value?lib$es6$promise$$internal$$reject(promise,new TypeError("You cannot resolve a promise with itself")):("function"==typeof(x=value)||"object"==typeof x&&null!==x?lib$es6$promise$$internal$$handleMaybeThenable:lib$es6$promise$$internal$$fulfill)(promise,
value)}function lib$es6$promise$$internal$$publishRejection(promise){promise._onerror&&promise._onerror(promise._result),lib$es6$promise$$internal$$publish(promise)}function lib$es6$promise$$internal$$fulfill(promise,value){promise._state===lib$es6$promise$$internal$$PENDING&&(promise._result=value,promise._state=lib$es6$promise$$internal$$FULFILLED,0!==promise._subscribers.length&&lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publish,promise))}function lib$es6$promise$$internal$$reject(promise,reason){promise._state===lib$es6$promise$$internal$$PENDING&&(promise._state=lib$es6$promise$$internal$$REJECTED,promise._result=reason,
lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publishRejection,promise))}function lib$es6$promise$$internal$$subscribe(parent,child,onFulfillment,onRejection){var subscribers=parent._subscribers,length=subscribers.length;parent._onerror=null,subscribers[length]=child,subscribers[length+lib$es6$promise$$internal$$FULFILLED]=onFulfillment,subscribers[length+lib$es6$promise$$internal$$REJECTED]=onRejection,0===length&&parent._state&&lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publish,parent)}function lib$es6$promise$$internal$$publish(promise){var subscribers=promise._subscribers,settled=promise._state;if(0!==subscribers.length){for(var child,
callback,detail=promise._result,i=0;i<subscribers.length;i+=3)child=subscribers[i],callback=subscribers[i+settled],child?lib$es6$promise$$internal$$invokeCallback(settled,child,callback,detail):callback(detail);promise._subscribers.length=0}}function lib$es6$promise$$internal$$ErrorObject(){this.error=null}var lib$es6$promise$$internal$$TRY_CATCH_ERROR=new lib$es6$promise$$internal$$ErrorObject;function lib$es6$promise$$internal$$invokeCallback(settled,promise,callback,detail){var value,error,succeeded,failed,hasCallback=lib$es6$promise$utils$$isFunction(callback);if(hasCallback){if((value=function(callback,detail){try{return callback(detail)}catch(e){
...
promise,value):this._result[i]=value),0===this._remaining&&lib$es6$promise$$internal$$fulfill(promise,this._result)},lib$es6$promise$enumerator$$Enumerator.prototype._willSettleAt=function(promise,i){var enumerator=this;lib$es6$promise$$internal$$subscribe(promise,void 0,function(value){enumerator._settledAt(lib$es6$promise$$internal$$FULFILLED,i,value)},function(reason){enumerator._settledAt(lib$es6$promise$$internal$$REJECTED,i,reason)})};function lib$es6$promise$promise$race$$default(entries){var promise=new this(lib$es6$promise$$internal$$noop);if(!lib$es6$promise$utils$$isArray(entries))return lib$es6$promise$$internal$$reject(promise,new TypeError(
"You must pass an array to race.")),promise;var length=entries.length;function onFulfillment(value){lib$es6$promise$$internal$$resolve(promise,value)}function onRejection(reason){lib$es6$promise$$internal$$reject(promise,reason)}for(var i=0;promise._state===lib$es6$promise$$internal$$PENDING&&i<length;i++)lib$es6$promise$$internal$$subscribe(this.resolve(entries[i]),void 0,onFulfillment,onRejection);return promise}function lib$es6$promise$promise$resolve$$default(object){if(object&&"object"==typeof object&&object.constructor===this)return object;var promise=new this(lib$es6$promise$$internal$$noop);return lib$es6$promise$$internal$$resolve(promise,object),
promise}function lib$es6$promise$promise$reject$$default(reason){var promise=new this(lib$es6$promise$$internal$$noop);return lib$es6$promise$$internal$$reject(promise,reason),promise}var lib$es6$promise$promise$$counter=0;var lib$es6$promise$promise$$default=lib$es6$promise$promise$$Promise;function lib$es6$promise$promise$$Promise(resolver){this._id=lib$es6$promise$promise$$counter++,this._state=void 0,this._result=void 0,this._subscribers=[],lib$es6$promise$$internal$$noop!==resolver&&(lib$es6$promise$utils$$isFunction(resolver)||function(){throw new TypeError("You must pass a resolver function as the first argument to the promise constructor")}(),
...
'<svg><p><style><img src="</style><img src=x onerror=1//">').querySelector("svg img")&&(useDOMParser=!0)}catch(err){}}(),function(){try{_initDocument("<x/><title>&lt;/title&gt;&lt;img&gt;").querySelector("title").innerHTML.match(/<\/title/)&&(removeTitle=!0)}catch(err){}}());function _sanitizeShadowDOM(fragment){var shadowNode=void 0,shadowIterator=_createIterator(fragment);for(_executeHook("beforeSanitizeShadowDOM",fragment,null);shadowNode=shadowIterator.nextNode();)_executeHook("uponSanitizeShadowNode",shadowNode,null),_sanitizeElements(shadowNode)||(shadowNode.content instanceof DocumentFragment&&_sanitizeShadowDOM(shadowNode.content),
_sanitizeAttributes(shadowNode));_executeHook("afterSanitizeShadowDOM",fragment,null)}var _createIterator=function(root){return createNodeIterator.call(root.ownerDocument||root,root,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_TEXT,function(){return NodeFilter.FILTER_ACCEPT},!1)},_isNode=function(obj){return"object"===(void 0===Node?"undefined":_typeof(Node))?obj instanceof Node:obj&&"object"===(void 0===obj?"undefined":_typeof(obj))&&"number"==typeof obj.nodeType&&"string"==typeof obj.nodeName},_executeHook=function(entryPoint,currentNode,data){hooks[entryPoint]&&hooks[entryPoint].forEach(function(hook){hook.call(DOMPurify,currentNode,
data,CONFIG)})},_sanitizeElements=function(currentNode){var elm,content=void 0;if(_executeHook("beforeSanitizeElements",currentNode,null),!((elm=currentNode)instanceof Text||elm instanceof Comment||"string"==typeof elm.nodeName&&"string"==typeof elm.textContent&&"function"==typeof elm.removeChild&&elm.attributes instanceof NamedNodeMap&&"function"==typeof elm.removeAttribute&&"function"==typeof elm.setAttribute))return _forceRemove(currentNode),!0;var tagName=currentNode.nodeName.toLowerCase();if(_executeHook("uponSanitizeElement",currentNode,{tagName:tagName,allowedTags:ALLOWED_TAGS}),ALLOWED_TAGS[tagName]&&!FORBID_TAGS[tagName]
)return!SAFE_FOR_JQUERY||currentNode.firstElementChild||currentNode.content&&currentNode.content.firstElementChild||!/</g.test(currentNode.textContent)||(DOMPurify.removed.push({element:currentNode.cloneNode()}),currentNode.innerHTML?currentNode.innerHTML=currentNode.innerHTML.replace(/</g,"&lt;"):currentNode.innerHTML=currentNode.textContent.replace(/</g,"&lt;")),SAFE_FOR_TEMPLATES&&3===currentNode.nodeType&&(content=(content=(content=currentNode.textContent).replace(MUSTACHE_EXPR$$1," ")).replace(ERB_EXPR$$1," "),currentNode.textContent!==content&&(DOMPurify.removed.push({element:currentNode.cloneNode()}),currentNode.textContent=content)),_executeHook(
"afterSanitizeElements",currentNode,null),!1;if(KEEP_CONTENT&&!FORBID_CONTENTS[tagName]&&"function"==typeof currentNode.insertAdjacentHTML)try{var htmlToInsert=currentNode.innerHTML;currentNode.insertAdjacentHTML("AfterEnd",trustedTypesPolicy?trustedTypesPolicy.createHTML(htmlToInsert):htmlToInsert)}catch(err){}return _forceRemove(currentNode),!0},_isValidAttribute=function(lcTag,lcName,value){if(SANITIZE_DOM&&("id"===lcName||"name"===lcName)&&(value in document||value in formElement))return!1;if(SAFE_FOR_TEMPLATES&&(value=(value=value.replace(MUSTACHE_EXPR$$1," ")).replace(ERB_EXPR$$1," ")),!(ALLOW_DATA_ATTR&&DATA_ATTR$$1.test(lcName
)||ALLOW_ARIA_ATTR&&ARIA_ATTR$$1.test(lcName))){if(!ALLOWED_ATTR[lcName]||FORBID_ATTR[lcName])return!1;if(!URI_SAFE_ATTRIBUTES[lcName]&&!IS_ALLOWED_URI$$1.test(value.replace(ATTR_WHITESPACE$$1,""))&&("src"!==lcName&&"xlink:href"!==lcName||"script"===lcTag||0!==value.indexOf("data:")||!DATA_URI_TAGS[lcTag])&&(!ALLOW_UNKNOWN_PROTOCOLS||IS_SCRIPT_OR_DATA$$1.test(value.replace(ATTR_WHITESPACE$$1,"")))&&value)return!1}return!0},_sanitizeAttributes=function(currentNode){var attr=void 0,value=void 0,lcName=void 0,idAttr=void 0,l=void 0;_executeHook("beforeSanitizeAttributes",currentNode,null);var attributes=currentNode.attributes;if(attributes){var hookEvent={
attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ALLOWED_ATTR};for(l=attributes.length;l--;){var name=(attr=attributes[l]).name,namespaceURI=attr.namespaceURI;if(value=attr.value.trim(),lcName=name.toLowerCase(),hookEvent.attrName=lcName,hookEvent.attrValue=value,hookEvent.keepAttr=!0,_executeHook("uponSanitizeAttribute",currentNode,hookEvent),value=hookEvent.attrValue,"name"===lcName&&"IMG"===currentNode.nodeName&&attributes.id)idAttr=attributes.id,attributes=apply(arraySlice,attributes,[]),_removeAttribute("id",currentNode),_removeAttribute(name,currentNode),attributes.indexOf(idAttr)>l&&currentNode.setAttribute("id",idAttr.value);else{if(
"INPUT"===currentNode.nodeName&&"type"===lcName&&"file"===value&&(ALLOWED_ATTR[lcName]||!FORBID_ATTR[lcName]))continue;"id"===name&&currentNode.setAttribute(name,""),_removeAttribute(name,currentNode)}if(hookEvent.keepAttr){var lcTag=currentNode.nodeName.toLowerCase();if(_isValidAttribute(lcTag,lcName,value))try{namespaceURI?currentNode.setAttributeNS(namespaceURI,name,value):currentNode.setAttribute(name,value),DOMPurify.removed.pop()}catch(err){}}}_executeHook("afterSanitizeAttributes",currentNode,null)}};return DOMPurify.sanitize=function(dirty,cfg){var body=void 0,importedNode=void 0,currentNode=void 0,oldNode=void 0,returnNode=void 0;if(
"string"!=typeof(dirty=dirty||"\x3c!--\x3e")&&!_isNode(dirty)){if("function"!=typeof dirty.toString)throw new TypeError("toString is not a function");if("string"!=typeof(dirty=dirty.toString()))throw new TypeError("dirty is not a string, aborting")}if(!DOMPurify.isSupported){if("object"===_typeof(window.toStaticHTML)||"function"==typeof window.toStaticHTML){if("string"==typeof dirty)return window.toStaticHTML(dirty);if(_isNode(dirty))return window.toStaticHTML(dirty.outerHTML)}return dirty}if(SET_CONFIG||_parseConfig(cfg),DOMPurify.removed=[],!IN_PLACE)if(dirty instanceof Node)1===(importedNode=(body=_initDocument("\x3c!--\x3e")).ownerDocument.importNode(
dirty,!0)).nodeType&&"BODY"===importedNode.nodeName?body=importedNode:body.appendChild(importedNode);else{if(!RETURN_DOM&&!WHOLE_DOCUMENT&&-1===dirty.indexOf("<"))return trustedTypesPolicy?trustedTypesPolicy.createHTML(dirty):dirty;if(!(body=_initDocument(dirty)))return RETURN_DOM?null:emptyHTML}body&&FORCE_BODY&&_forceRemove(body.firstChild);for(var nodeIterator=_createIterator(IN_PLACE?dirty:body);currentNode=nodeIterator.nextNode();)3===currentNode.nodeType&&currentNode===oldNode||_sanitizeElements(currentNode)||(currentNode.content instanceof DocumentFragment&&_sanitizeShadowDOM(currentNode.content),_sanitizeAttributes(currentNode),oldNode=currentNode)
;if(oldNode=null,IN_PLACE)return dirty;if(RETURN_DOM){if(RETURN_DOM_FRAGMENT)for(returnNode=createDocumentFragment.call(body.ownerDocument);body.firstChild;)returnNode.appendChild(body.firstChild);else returnNode=body;return RETURN_DOM_IMPORT&&(returnNode=importNode.call(originalDocument,returnNode,!0)),returnNode}var serializedHTML=WHOLE_DOCUMENT?body.outerHTML:body.innerHTML;return trustedTypesPolicy?trustedTypesPolicy.createHTML(serializedHTML):serializedHTML},DOMPurify.setConfig=function(cfg){_parseConfig(cfg),SET_CONFIG=!0},DOMPurify.clearConfig=function(){CONFIG=null,SET_CONFIG=!1},DOMPurify.isValidAttribute=function(tag,attr,value){
CONFIG||_parseConfig({});var lcTag=tag.toLowerCase(),lcName=attr.toLowerCase();return _isValidAttribute(lcTag,lcName,value)},DOMPurify.addHook=function(entryPoint,hookFunction){"function"==typeof hookFunction&&(hooks[entryPoint]=hooks[entryPoint]||[],hooks[entryPoint].push(hookFunction))},DOMPurify.removeHook=function(entryPoint){hooks[entryPoint]&&hooks[entryPoint].pop()},DOMPurify.removeHooks=function(entryPoint){hooks[entryPoint]&&(hooks[entryPoint]=[])},DOMPurify.removeAllHooks=function(){hooks={}},DOMPurify}()}),define("tpl!ui/component/tpl/component",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),'<div class="component"></div>'})}),define("tpl!ui/feedback/feedback",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div id="',buffer+=escapeExpression(stack1=(helper=helpers.id)||"function"==typeof(helper=depth0&&depth0.id)?helper.call(depth0,{hash:{},data:data}):helper)+'" class="feedback feedback-',
buffer+=escapeExpression(stack1=(helper=helpers.level)||"function"==typeof(helper=depth0&&depth0.level)?helper.call(depth0,{hash:{},data:data}):helper)+" ",!(stack1=helpers.if.call(depth0,depth0&&depth0.popup,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return"popup"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='">\n    <span class="icon-',buffer+=escapeExpression(stack1=(helper=helpers.level)||"function"==typeof(helper=depth0&&depth0.level)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n    <div>\n        ',options={hash:{},data:data},!(stack1=(helper=helpers.dompurify||depth0&&depth0.dompurify)?helper.call(
depth0,depth0&&depth0.msg,options):helperMissing.call(depth0,"dompurify",depth0&&depth0.msg,options))&&0!==stack1||(buffer+=stack1),buffer+='\n    </div>\n    <span title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Close message",options):helperMissing.call(depth0,"__","Close message",options)))+'" class="icon-close" data-close=":parent .feedback"></span>\n</div>'})}),define("tpl!ui/dialog/tpl/body",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{}
;var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<div class="preview-modal-feedback modal">\n    <div class="modal-body clearfix">\n        ',!(stack1=helpers.if.call(depth0,depth0&&depth0.heading,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+='\n        <h4 class="strong">',stack1=(helper=helpers.heading)||typeof(helper=depth0&&depth0.heading)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h4>\n        "},data),data:data}))&&0!==stack1||(buffer+=stack1),
buffer+='\n\n        <p class="message">',stack1=(helper=helpers.message)||typeof(helper=depth0&&depth0.message)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</p>\n\n        ",!(stack1=helpers.if.call(depth0,depth0&&depth0.content,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+='\n        <div class="content">',!(stack1=(helper=helpers.content)||typeof(helper=depth0&&depth0.content)===functionType?helper.call(depth0,{hash:{},data:data}):helper)&&0!==stack1||(buffer+=stack1),buffer+="</div>\n        "},data),data:data}))&&0!==stack1||(
buffer+=stack1),buffer+='\n\n        <div class="buttons rgt"></div>\n    </div>\n</div>'})}),define("tpl!ui/dialog/tpl/buttons",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,functionType="function",escapeExpression=this.escapeExpression,self=this;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)||typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+'"></span> '}return(stack1=helpers.each.call(depth0,depth0&&depth0.buttons,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+='\n    <button class="btn-',stack1=(helper=helpers.type)||typeof(helper=depth0&&depth0.type)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+" small ",stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" data-control="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},
data:data}):helper,buffer+=escapeExpression(stack1)+'" type="button">\n        ',!(stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:self.noop,fn:self.program(2,program2,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n        <span class="label">',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span>\n    </button>\n"},data),data:data}))||0===stack1?stack1:""})}),define("layout/logout-event",["jquery","lodash","i18n","util/url","ui/dialog/alert"],function($,_,__,url,alert){"use strict";var defaults={message:__(
"You have been logged out. Please login again"),redirectUrl:url.route("logout","Main","tao")};return function(options){options=_.defaults(options||{},defaults),alert(options.message,function(){window.location=options.redirectUrl})}}),define("controller/app",["lodash","jquery","core/historyRouter","core/logger","core/eventifier","core/statifier","util/url","ui/feedback","layout/logout-event"],function(_,$,historyRouterFactory,loggerFactory,eventifier,statifier,urlUtil,feedback,logoutEvent){"use strict";var historyRouter,redirectUrl,appLogger=loggerFactory("controller/app"),appController=eventifier(statifier({start:function(options){var currentRoute
;appController.apply(),currentRoute=options&&options.forwardTo?options.forwardTo:window.location+"",options&&options.redirectUrl&&(redirectUrl=options.redirectUrl||{}),historyRouter.forward(currentRoute)},apply:function(selector,target){return selector=selector||".router",target=target||document,$(target).off("click.appController").on("click.appController",selector,function(e){var $elt,href;e.preventDefault(),(href=(href=($elt=$(this)).attr("href"))||$("[href]:first-child",$elt).attr("href"))&&historyRouter.redirect(href)}),this},getRouter:function(){return historyRouter},getLogger:function(){return appLogger},onError:function(err){
...
computedStyle)}}var createClass=function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor};function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}function defineProperty(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}
...
function getOffsetRectRelativeToArbitraryNode(children,parent,argument_2){var fixedPosition=2<arguments.length&&void 0!==argument_2&&argument_2,isIE10=isIE(10),isHTML="HTML"===parent.nodeName,childrenRect=getBoundingClientRect(children),parentRect=getBoundingClientRect(parent),scrollParent=getScrollParent(children),styles=getStyleComputedProperty(parent),borderTopWidth=parseFloat(styles.borderTopWidth,10),borderLeftWidth=parseFloat(styles.borderLeftWidth,10);fixedPosition&&isHTML&&(parentRect.top=Math.max(parentRect.top,0),parentRect.left=Math.max(parentRect.left,0));var offsets=getClientRect({top:childrenRect.top-parentRect.top-borderTopWidth,
...
boundaries.right-=isPaddingNumber?padding:padding.right||0,boundaries.bottom-=isPaddingNumber?padding:padding.bottom||0,boundaries}function computeAutoPlacement(placement,refRect,popper,reference,boundariesElement,argument_5){var padding=5<arguments.length&&void 0!==argument_5?argument_5:0;if(-1===placement.indexOf("auto"))return placement;var boundaries=getBoundaries(popper,reference,padding,boundariesElement),rects={top:{width:boundaries.width,height:refRect.top-boundaries.top},right:{width:boundaries.right-refRect.right,height:boundaries.height},bottom:{width:boundaries.width,height:boundaries.bottom-refRect.bottom},left:{
width:refRect.left-boundaries.left,height:boundaries.height}},sortedAreas=Object.keys(rects).map(function(key){return _extends({key:key},rects[key],{area:(_ref=rects[key]).width*_ref.height});var _ref}).sort(function(a,b){return b.area-a.area}),filteredAreas=sortedAreas.filter(function(_ref2){var width=_ref2.width,height=_ref2.height;return width>=popper.clientWidth&&height>=popper.clientHeight}),computedPlacement=0<filteredAreas.length?filteredAreas[0].key:sortedAreas[0].key,variation=placement.split("-")[1];return computedPlacement+(variation?"-"+variation:"")}function getReferenceOffsets(state,popper,reference,argument_3){
var fixedPosition=3<arguments.length&&void 0!==argument_3?argument_3:null;return getOffsetRectRelativeToArbitraryNode(reference,fixedPosition?getFixedPositionOffsetParent(popper):findCommonOffsetParent(popper,reference),fixedPosition)}function getOuterSizes(element){var styles=element.ownerDocument.defaultView.getComputedStyle(element),x=parseFloat(styles.marginTop)+parseFloat(styles.marginBottom),y=parseFloat(styles.marginLeft)+parseFloat(styles.marginRight);return{width:element.offsetWidth+y,height:element.offsetHeight+x}}function getOppositePlacement(placement){var hash={left:"right",right:"left",bottom:"top",top:"bottom"};return placement.replace(
...
return modifier.name===requestedName&&modifier.enabled&&modifier.order<requesting.order});if(!isRequired){var _requesting="`"+requestingName+"`",requested="`"+requestedName+"`";console.warn(requested+" modifier is required by "+_requesting+" modifier in order to work, be sure to include it before "+_requesting+"!")}return isRequired}var placements=["auto-start","auto","auto-end","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom","bottom-start","left-end","left","left-start"],validPlacements=placements.slice(3);function clockwise(placement,argument_1){var counter=1<arguments.length&&void 0!==argument_1&&argument_1,
...
Popper.Defaults=Defaults,Popper}),function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?module.exports=factory(require("./popper")):"function"==typeof define&&define.amd?define("lib/popper/tooltip",["./popper"],factory):global.Tooltip=factory(global.Popper)}(this,function(Popper){"use strict";Popper=Popper&&Popper.hasOwnProperty("default")?Popper.default:Popper;var createClass=function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor};function defineProperties(target,props){for(var i=0;i<props.length;i++){
var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source)Object.prototype.hasOwnProperty.call(source,key)&&(target[key]=source[key])}return target},DEFAULT_OPTIONS={container:!1,delay:0,html:!1,placement:"top",title:"",template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",offset:0,
...
section.panel.show(),self.scope.trigger("show.section",[section])}),this},refresh:function(){return this.sections={},this.init()},enable:function(){return this.selected||this.current(),!0===this.selected.disabled&&(this.selected.disabled=!1,this.selected.opener.removeClass("disabled"),this.scope.trigger("enable.section",[this.selected])),this},disable:function(){return this.selected||this.current(),!1===this.selected.disabled&&(this.selected.disabled=!0,this.selected.opener.addClass("disabled"),this.scope.trigger("disable.section",[this.selected])),this},current:function(){return this.selected=_(this.sections).where({active:!0}).first(),this},
create:function(data){var $sectionOpener,$sectionPanel,section,$openersContainer=this.scope.find(".tab-container");if(!_.isObject(data))throw new TypeError("The create() method requires an object with section data as parameter.");if(!_.isString(data.id)||!_.isString(data.url)||!_.isString(data.name))throw new TypeError("The create() method requires data with id, url and name to create a new section.");return void 0===data.visible&&(data.visible=!0),this.get(data.id),(section=this.selected&&this.selected.id===data.id?this.selected:void 0)||($sectionPanel=$('<div id="panel-'+data.id+'" class="clear"></div>'),!0===data.contentBlock&&$sectionPanel.append(
...
).click(function(e){e.preventDefault(),$.ajax({url:helpers._url("forceRelease","Lock","tao"),type:"POST",data:{uri:$(this).data("id")},dataType:"json",success:function(response){response.success?(feedback().success(__("The lock has been released")),$(".tree").trigger("refresh.taotree")):feedback().error(__("Unable to release the lock"))},error:function(){feedback().error(__("Unable to release the lock"))}})})}}}),define("layout/version-warning",["jquery","jquery.cookie"],function($){"use strict";var versionWarning=$(".version-warning");function hideWarning(slide){function callback(){document.documentElement.className+=" no-version-warning",
versionWarning.trigger("hiding.versionwarning")}slide?versionWarning.slideUp("slow",function(){versionWarning.slideUp("slow",callback)}):(versionWarning.hide(),callback())}return{init:function(){$.cookie("versionWarning")?hideWarning(!1):versionWarning.find(".close-trigger").on("click",function(){$.cookie("versionWarning",!0,{path:"/"}),hideWarning(!0)})}}}),define("tpl!ui/login/tpl/login",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",
escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;function program3(depth0,data){return' autocomplete="off"'}function program5(depth0,data){var stack1,buffer="";return buffer+='\n                <div class="form-error">\n                    '+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.fieldMessages)||!1===stack1?stack1:stack1.login)===functionType?stack1.apply(depth0):stack1)+"\n                </div>\n            "}return buffer+='<div class="xhtml_form login-component">\n    <form action="',stack1=(helper=helpers.url)||typeof(helper=depth0&&depth0.url)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
...
versionWarning.init(),loadingBar.stop()}).on("submit.login",function(){loadingBar.start()})}}}),define("form/post-render-props",["jquery","i18n","ui/feedback"],function($,__,feedback){"use strict";function _toggleModeBtn(newMode){var $modeToggle=$(".property-mode");"disabled"===newMode?$modeToggle.addClass("disabled"):$modeToggle.removeClass("disabled")}function _upgradeButtons($container,type){"radio"!==type&&"checkbox"!==type&&(type="radio");var selector=".form_checklst",notSelector="";"radio"===type&&(selector=".form_radlst",notSelector=".form_checklst, "),$container.find(selector).not(notSelector+".property-"+type+"-list").each(function(){
...
property["http_2_www_0_w3_0_org_1_2000_1_01_1_rdf-schema_3_range"]=range),$(":input.property",this).each(function(){var $property=$(this);name=$property.attr("name").replace(/(property_)?[^_]+_/,""),isArray=name.indexOf("[]")===name.length-2,"checkbox"===$property.attr("type")&&isArray?(name=name.substr(0,name.length-2),$property.is(":checked")&&(_.isArray(property[name])||(property[name]=[]),property[name].push($property.val()))):"radio"===$property.attr("type")&&!$property.is(":checked")||(property[name]=$property.val())}),$(":input.index",this).each(function(){var i,found=!1,name="",$index=$(this);for(i in indexes)indexes[i]&&$index.attr(
"data-related-index")===indexes[i].uri&&(name=$index.attr("name").replace(/(index_)?[^_]+_/,""),("radio"!==$index.attr("type")&&"checkbox"!==$index.attr("type")||$index.is(":checked"))&&(indexes[i][name]=$index.val()),found=!0);if(!found){var index={};index.uri=$index.attr("data-related-index"),name=$index.attr("name").replace(/(index_)?[^_]+_/,""),"radio"===$index.attr("type")&&!$index.is(":checked")||(index[name]=$index.val()),indexes.push(index)}}),property.indexes=indexes,properties.push(property)}),formData.properties=properties,formData},initElements:function(){var $uriElm,$classUriElm,self=this;$(".form-refresher").off("click").on("click",function(){
var $form=$(this).parents("form");return $(":input[name='"+$form.attr("name")+"_sent']").remove(),$form.submit()}),$uriElm=$("#uri"),$classUriElm=$("#classUri"),$(".form-translator").off("click").on("click",function(){return $uriElm.length&&$classUriElm.length&&helpers.getMainContainer().load(getUrl("translateInstance"),{uri:$uriElm.val(),classUri:$classUriElm.val()}),!1}),$(".html-area").each(function(){var propertyUri=this.id,editor=ckeditor.replace(this);editor.config=ckConfigurator.getConfig(editor,"htmlField",{resize_enabled:!1}),self.htmlEditors[propertyUri]=editor}),$(".box-checker").off("click").on("click",function(){var $checker=$(this),
regexpId=new RegExp("^"+$checker.prop("id").replace("_checker",""),"i");return $checker.hasClass("box-checker-uncheck")?($(":checkbox:not(:disabled)").each(function(){regexpId.test(this.id)&&(this.checked=!1,$(this).change())}),$checker.removeClass("box-checker-uncheck"),$checker.text(__("Check all"))):($(":checkbox:not(:disabled)").each(function(){regexpId.test(this.id)&&(this.checked=!0,$(this).change())}),$checker.addClass("box-checker-uncheck"),$checker.text(__("Uncheck all"))),!1})},initOntoForms:function(){$(".authoringOpener").click(function(){var $wantedPanel,tabUrl=getUrl("authoring"),tabId="panel-"+module.config().module.toLowerCase()+"_authoring",
$tabContainer=$("#tabs"),$panel=(($wantedPanel=$tabContainer.find("#"+tabId)).length||($wantedPanel=$("<div>",{id:tabId,class:"clear content-panel"}).hide(),$tabContainer.find(".content-panel").after($wantedPanel)),$wantedPanel);$.ajax({type:"GET",url:tabUrl,data:{uri:$("#uri").val(),classUri:$("#classUri").val()},dataType:"html",success:function(responseHtml){$tabContainer.find(".content-panel").not($panel).hide(),window.location.hash=tabId,(responseHtml=$(responseHtml)).find("#authoringBack").click(function(){var $myPanel=$(this).parents(".content-panel"),$otherPanel=$myPanel.prev();$myPanel.hide(),$otherPanel.show()}),$panel.html(responseHtml).show()}})})
,$("input.editVersionedFile").each(function(){var infoUrl=context.root_url+"tao/File/getPropertyFileInfo",data={uri:$("#uri").val(),propertyUri:$(this).siblings("label.form_desc").prop("for")},$_this=$(this);$.ajax({type:"GET",url:infoUrl,data:data,dataType:"json",success:function(r){$_this.after("<span>"+r.name+"</span>")}})}).click(function(){var data={uri:$("#uri").val(),propertyUri:$(this).siblings("label.form_desc").prop("for")};return helpers.getMainContainer().load(getUrl("editVersionedFile"),data),!1}),$(".property-deleter").off("click").on("click",function(){if(window.confirm(__("Please confirm property deletion!"))){var $groupNode=$(this).closest(
".form-group");property.remove($(this).data("uri"),$("#id").val(),helpers._url("removeClassProperty","PropertiesAuthoring","tao"),function(){$groupNode.remove()})}}),$(".property-adder").off("click").on("click",function(e){e.preventDefault(),property.add($("#id").val(),helpers._url("addClassProperty","PropertiesAuthoring","tao"))}),$(".index-adder").off("click").on("click",function(e){e.preventDefault();var $prependTo=$(this).closest("div"),$groupNode=$(this).closest(".form-group");if($groupNode.length){var max=0,$propertyindex=$(".property-uri",$groupNode),propertyindex=parseInt($propertyindex.attr("id").replace(/[\D]+/,""));$groupNode.find("[data-index]"
).each(function(){max<$(this).data("index")&&(max=$(this).data("index"))}),max+=1;var uri=$groupNode.find(".property-uri").val();$.ajax({type:"GET",url:helpers._url("addPropertyIndex","PropertiesAuthoring","tao"),data:{uri:uri,index:max,propertyIndex:propertyindex},dataType:"json",success:function(response){$prependTo.before(response.form)}})}}),$(".property-edit-container").off("click",".index-remover").on("click",".index-remover",function(e){e.preventDefault();var $groupNode=$(this).closest(".form-group"),uri=$groupNode.find(".property-uri").val(),$editContainer=$($groupNode[0]).children(".property-edit-container");$.ajax({type:"POST",url:helpers._url(
"removePropertyIndex","PropertiesAuthoring","tao"),data:{uri:uri,indexProperty:$(this).attr("id")},dataType:"json",success:function(response){$('[id*="'+response.id+'"], [data-related-index="'+response.id+'"]').each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$editContainer[0])&&void 0!==$currentTarget.parent()[0];)$currentTarget=$currentTarget.parent();$currentTarget.remove()})}})}),$(".property-mode").off("click").on("click",function(){var url,$btn=$(this),mode="simple";if(!$btn.hasClass("disabled"))return $btn.hasClass("property-mode-advanced")&&(mode="advanced"),url=$btn.parents("form").prop("action"),
helpers.getMainContainer().load(url,{property_mode:mode,uri:$("#uri").val(),id:$("#id").val(),classUri:$("#classUri").val()}),!1}),$(".property-template").each(function(){$(this).closest("div").hide()});var $propertyType=$(".property-type"),$propertyListValues=$(".property-listvalues");$propertyType.on("change",function(){var $this=$(this),$elt=$this.parent("div").next("div"),propertiesTypes=["list","tree"];new RegExp(propertiesTypes.join("$|").concat("$")).test($this.val())?"none"===$elt.css("display")&&($elt.show(),$elt.find("select").removeAttr("disabled")):"none"!==$elt.css("display")&&($elt.css("display","none"),$elt.find("select").prop("disabled",!1),
$elt.find('select option[value=" "]').prop("selected",!0)),$.each(propertiesTypes,function(i,rangedPropertyName){if(new RegExp(rangedPropertyName+"$").test($this.val()))return $elt.find("select").html($elt.closest(".property-edit-container").find("."+rangedPropertyName+"-template").html()),!0})}).trigger("change"),$propertyListValues.off("change"),$propertyListValues.on("change",function(){var $this=$(this),elt=$this.parent("div");if("new"===$this.val()){var rangeId=$this.prop("id"),dialogId=rangeId.replace("_range","_dialog"),treeId=rangeId.replace("_range","_tree"),closerId=rangeId.replace("_range","_closer");elt.append(
"<div id='"+dialogId+"' style='display:none;' > <span class='ui-state-highlight' style='margin:15px;'>"+__("Right click the tree to manage your lists")+"</span><br /><br /><div id='"+treeId+"' ></div> <div style='text-align:center;margin-top:30px;'> <a id='"+closerId+"' class='ui-state-default ui-corner-all' href='#'>"+__("Save")+"</a> </div> </div>");var $dialogElm=$("#"+dialogId);$dialogElm.dialog({width:350,height:400,autoOpen:!1,title:__("Manage data list")}),$dialogElm.bind("dialogclose",function(event,ui){$.tree.reference("#"+treeId).destroy(),$dialogElm.dialog("destroy"),$dialogElm.remove()}),$("#"+closerId).click(function(){$("#"+dialogId).dialog(
"close")}),$dialogElm.bind("dialogopen",function(event,ui){var url=context.root_url+"taoBackOffice/Lists/",dataUrl=url+"getListsData",renameUrl=url+"rename",createUrl=url+"create",removeListUrl=url+"removeList",removeListEltUrl=url+"removeListElement";$("#"+treeId).tree({data:{type:"json",async:!0,opts:{method:"POST",url:dataUrl}},types:{default:{renameable:!0,deletable:!0,creatable:!0,draggable:!1}},ui:{theme_name:"custom"},callback:{onrename:function(NODE,TREE_OBJ){var data={uri:$(NODE).prop("id"),newName:TREE_OBJ.get_text(NODE)};$(NODE).hasClass("node-instance")&&(data.classUri=$(TREE_OBJ.parent(NODE)).prop("id")),$.ajax({url:renameUrl,type:"POST",
data:data,dataType:"json",success:function(response){response.renamed||TREE_OBJ.rename(NODE,response.oldName)}})},ondestroy:function(TREE_OBJ){var $rangeElm=$("#"+rangeId);$rangeElm.find("option").each(function(){var $option=$(this);""!==$option.val()&&"new"!==$option.val()&&$option.remove()}),$("#"+treeId+" .node-root .node-class").each(function(){$rangeElm.find("option[value='new']").before("<option value='"+$(this).prop("id")+"'>"+$(this).children("a:first").text()+"</option>")}),$rangeElm.parent("div").children("ul.form-elt-list").remove(),$rangeElm.val("")}},plugins:{contextmenu:{items:{create:{label:__("Create"),icon:context.taobase_www+"img/add.png",
visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-instance")&&TREE_OBJ.check("creatable",NODE)},action:function(NODE,TREE_OBJ){if($(NODE).hasClass("node-class")){$.ajax({url:createUrl,type:"POST",data:{classUri:$(NODE).prop("id"),type:"instance"},dataType:"json",success:function(response){response.uri&&TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:"node-instance"}},TREE_OBJ.get_node(NODE[0])))}})}return $(NODE).hasClass("node-root")&&$.ajax({url:createUrl,type:"POST",data:{classUri:"root",type:"class"},dataType:"json",success:function(response){response.uri&&TREE_OBJ.select_branch(TREE_OBJ.create({
data:response.label,attributes:{id:response.uri,class:"node-class"}},TREE_OBJ.get_node(NODE[0])))}}),!1}},rename:{label:__("Rename"),icon:context.taobase_www+"img/rename.png",visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-root")&&TREE_OBJ.check("renameable",NODE)}},remove:{label:__("Remove"),icon:context.taobase_www+"img/delete.png",visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-root")&&TREE_OBJ.check("deletable",NODE)},action:function(NODE,TREE_OBJ){var removeUrl;return $(NODE).hasClass("node-root")||($(NODE).hasClass("node-class")&&(removeUrl=removeListUrl),$(NODE).hasClass("node-instance")&&(removeUrl=removeListEltUrl),
$.ajax({url:removeUrl,type:"POST",data:{uri:$(NODE).prop("id")},dataType:"json",success:function(response){response.deleted&&TREE_OBJ.remove(NODE)}})),!1}}}}}})}),$dialogElm.dialog("open")}else{$(elt).parent("div").children("ul.form-elt-list").remove();var classUri=$this.val();""!==classUri&&" "!==classUri&&($this.parent("div").children("div.form-error").remove(),$.ajax({url:context.root_url+"taoBackOffice/Lists/getListElements",type:"POST",data:{listUri:classUri},dataType:"json",success:function(response){var property,html="<ul class='form-elt-list'>";for(property in response)response.hasOwnProperty(property)&&(html+="<li>"+encode.html(response[property]
)+"</li>");html+="</ul>",$(elt).parent("div").append(html)}}))}}).trigger("change"),$propertyListValues.each(function(){var listControl,listField=$(this);0===listField.parent().find("img").length&&((listControl=$("<img title='manage lists' class='manage-lists' style='cursor:pointer;' />")).prop("src",context.taobase_www+"img/add.png"),listControl.click(function(){listField.val("new"),listField.change()}),listControl.insertAfter(listField))}),$propertyListValues.each(function(){var elt=$(this).parent("div");elt.hasClass("form-elt-highlight")||"none"===elt.css("display")||elt.addClass("form-elt-highlight")})},initTranslationForm:function(){var self=this;$(
"#translate_lang").change(function(){var trLang=$(this).val();""!==trLang&&($("#translation_form").find(":input").each(function(){/^http/.test($(this).prop("name"))&&$(this).val("")}),$.post(getUrl("getTranslatedData"),{uri:$("#uri").val(),classUri:$("#classUri").val(),lang:trLang},function(response){var index,formElt;for(index in response)(formElt=$(":input[name='"+index+"']")).hasClass("html-area")&&self.htmlEditors[index]?self.htmlEditors[index].setData(response[index]):formElt.val(response[index])},"json"))})},submitForm:function(myForm,serialize){var $container,self=this;try{if("multipart/form-data"===myForm.prop("enctype")&&myForm.find(".file-uploader"
).length)return!1;if(!($container=myForm.closest(".content-block"))||0===$container.length)return!0;$(".html-area",myForm).each(function(){self.htmlEditors[this.id]&&self.htmlEditors[this.id].updateElement()}),serialize=void 0!==serialize?serialize:myForm.serializeArray(),$container.load(myForm.prop("action"),serialize)}catch(exp){return!1}return!1}}}),define("layout/actions/binder",["lodash"],function(_){"use strict";var bindings={};return{register:function(name,binding){bindings[name]=binding},exec:function(action,context){var name;if(action&&action.binding&&(name=action.binding,_.isFunction(bindings[name])))return bindings[name].call(action,context)}}}),
define("layout/permissions",["lodash","uri"],function(_,uriUtil){"use strict";var permissionStore={},supportedRights=[];return{setSupportedRights:function(rights){_.isArray(rights)&&(supportedRights=_.filter(rights,_.isString))},getRights:function(){return supportedRights},isSupported:function(right){return _.contains(supportedRights,right)},addPermissions:function(uri,permissions){return _.isString(uri)&&_.isArray(permissions)&&(permissionStore[uri]=_.intersection(permissions,_.values(this.getRights()))),_.isUndefined(permissions)&&_.isPlainObject(uri)&&(permissions=uri,_.forEach(permissions,function(value,key){this.addPermissions(key,value)},this)),this},
...
parameterValue=uriUtil.decode(resourceContext[requiredParameter]),self.hasPermission(parameterValue,right))})},getResourceAccessMode:function(uri){var self=this,mode="allowed",rights=this.getRights(),count=_.reduce(rights,function(acc,right){return self.hasPermission(uri,right)&&acc++,acc},0);return 0<rights.length&&count!==rights.length&&(mode=0===count?"denied":"partial"),mode}}}),define("provider/resources",["lodash","i18n","util/url","core/promise","core/dataProvider/request","layout/permissions"],function(_,__,urlUtil,Promise,request,permissionsManager){"use strict";function computeNodeAccessMode(nodes){return _.map(nodes,function(node){
return node.accessMode=permissionsManager.getResourceAccessMode(node.uri),_.isArray(node.children)&&(node.children=computeNodeAccessMode(node.children)),node})}var defaultConfig={getClasses:{url:urlUtil.route("getAll","RestClass","tao")},getResources:{url:urlUtil.route("getAll","RestResource","tao")},getClassProperties:{url:urlUtil.route("create","RestResource","tao")},copyTo:{},moveTo:{}};return function(config){return config=_.defaults(config||{},defaultConfig),{getClasses:function(classUri){return request(config.getClasses.url,{classUri:classUri})},getResources:function(params,computePermissions){return request(config.getResources.url,params).then(
function(results){var resources,currentRights;return resources=results&&results.resources?results.resources:results,computePermissions&&results.permissions&&(currentRights=permissionsManager.getRights(),results.permissions.supportedRights&&results.permissions.supportedRights.length&&0===currentRights.length&&permissionsManager.setSupportedRights(results.permissions.supportedRights),results.permissions.data&&permissionsManager.addPermissions(results.permissions.data),resources.nodes?resources.nodes=computeNodeAccessMode(resources.nodes):resources=computeNodeAccessMode(resources)),resources})},getClassProperties:function(classUri){return request(
...
helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'\n        <span class="selector clickable" tabindex="0"></span>\n    </a>\n</li>\n'},data),data:data},!(stack1=helper?helper.call(depth0,depth0&&depth0.type,"instance",options):helperMissing.call(depth0,"equal",depth0&&depth0.type,"instance",options))&&0!==stack1||(buffer+=stack1),buffer})}),define("tpl!ui/resource/tpl/list",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,
options,buffer="",helperMissing=helpers.helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="resource-list ',!(stack1=helpers.if.call(depth0,depth0&&depth0.multiple,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return"multiple"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='">\n    <ul></ul>\n    <div class="more hidden">\n        <a href="#" class="btn-info small"><span class="icon-download"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Load more",options):helperMissing.call(depth0,"__","Load more",options))
)+"</a>\n    </div>\n</div>"})}),define("tpl!ui/resource/tpl/listNode",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<li data-uri="',stack1=(helper=helpers.uri)||typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" ',!(stack1=helpers.if.call(depth0,depth0&&depth0.selected,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,
data){return'class="selected"'},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=' class="',stack1=(helper=helpers.state)||typeof(helper=depth0&&depth0.state)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" ',!(stack1=helpers.if.call(depth0,depth0&&depth0.accessMode,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+='data-access="',stack1=(helper=helpers.accessMode)||typeof(helper=depth0&&depth0.accessMode)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'},data),data:data}))&&0!==stack1||(
buffer+=stack1),buffer+='>\n    <a href="#" title="',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"><span class="icon-',stack1=(helper=helpers.icon)||typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span>',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</a>\n</li>"})}),define("tpl!ui/generis/validator/validator",["handlebars"],function(hb){
return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),'<div class="ui-generis-validator"></div>'})}),define("css!ui/generis/validator/validator",[],function(){}),define("tpl!ui/generis/widget/widget",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<label for="',stack1=(helper=helpers.uri
)||"function"==typeof(helper=depth0&&depth0.uri)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n    ',stack1=(helper=helpers.label)||"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"\n    ",!(stack1=helpers.if.call(depth0,depth0&&depth0.required,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <abbr title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"This field is required",options):helperMissing.call(depth0,"__",
"This field is required",options)))+'">*</abbr>\n    '},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n</label>"})}),define("css!ui/generis/widget/widget",[],function(){}),define("tpl!ui/generis/widget/checkBox/checkBox",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this,helperMissing=helpers.helperMissing;function program2(depth0,data){
...
helper=helpers.searchPlaceholder)||typeof(helper=depth0&&depth0.searchPlaceholder)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" />\n            ',!(stack1=helpers.if.call(depth0,depth0&&depth0.filters,{hash:{},inverse:self.noop,fn:self.program(10,program10,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n        </div>\n        <div class="selection-control">\n            <a href="#" class="selection-toggle ',!(stack1=helpers.unless.call(depth0,depth0&&depth0.switchMode,{hash:{},inverse:self.noop,fn:self.program(12,program12,data),data:data}))&&0!==stack1||(buffer+=stack1),
buffer+='" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Toggle multiple/single selection",options):helperMissing.call(depth0,"__","Toggle multiple/single selection",options)))+'">\n                <span class="icon-multi-select"></span>\n            </a>\n            <label class="selection-indicator ',!(stack1=helpers.unless.call(depth0,depth0&&depth0.multiple,{hash:{},inverse:self.noop,fn:self.program(12,program12,data),data:data}))&&0!==stack1||(buffer+=stack1),
buffer+='">\n                <input type="checkbox">\n                <span class="icon-checkbox"></span>\n            </label>\n        </div>\n        ',!(stack1=helpers.if.call(depth0,depth0&&depth0.filters,{hash:{},inverse:self.noop,fn:self.program(14,program14,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n    </nav>\n    "},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n\n    <main>\n        <span class="hidden no-results">',stack1=(helper=helpers.noResultsText)||typeof(helper=depth0&&depth0.noResultsText)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+"</span>\n    </main>\n\n    ",!(stack1=helpers.if.call(depth0,depth0&&depth0.multiple,{hash:{},inverse:self.noop,fn:self.program(16,function(depth0,data){var stack1,helper,options,buffer="";return buffer+='\n    <footer>\n        <div class="get-selection">\n           <span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Selected",options):helperMissing.call(depth0,"__","Selected",options)))+" ",stack1=(helper=helpers.type)||typeof(helper=depth0&&depth0.type)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+' : </span><span class="selected-num">0</span>\n        </div>\n    </footer>\n    '},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n</div>"})}),define("css!ui/resource/css/selector",[],function(){}),define("tpl!ui/loadingButton/tpl/button",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<button class="loading-button btn-',buffer+=escapeExpression((helper=helpers.type)||"function"==typeof(helper=depth0&&depth0.type)?helper.call(
depth0,{hash:{},data:data}):helper)+' small" type="button" title="',buffer+=escapeExpression((helper=helpers.title)||"function"==typeof(helper=depth0&&depth0.title)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n    <span class="spinner-icon icon-loop spinning"></span>\n    <span class="start-icon icon-',buffer+=escapeExpression((helper=helpers.icon)||"function"==typeof(helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n    <span class="action-label">',buffer+=escapeExpression((helper=helpers.label)||"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper
...
stack1=helpers.if.call(depth0,depth0&&depth0.noBorder,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return" no-border"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='">\n    ',!(stack1=helpers.if.call(depth0,depth0&&depth0.detailsButtonVisible,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var helper,options,buffer="";return buffer+='\n    <label class="fold pseudo-label-box">\n        <span class="check-txt hide">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Hide detailed report",options):helperMissing.call(depth0,"__","Hide detailed report",
...
"tpl!ui/report/feedback",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="feedback-',stack1=(helper=helpers.type)||typeof(helper=depth0&&depth0.type)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+" ",!(stack1=helpers.if.call(depth0,depth0&&depth0.hasChildren,{hash:{},inverse:this.program(3,function(depth0,data
){return"leaf"},data),fn:this.program(1,function(depth0,data){return"hierarchical"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='">\n    <span class="icon-',stack1=(helper=helpers.type)||typeof(helper=depth0&&depth0.type)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1),!(stack1=helpers.if.call(depth0,depth0&&depth0.hasChildren,{hash:{},inverse:this.noop,fn:this.program(5,function(depth0,data){return" hierarchical-icon"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='"></span>\n    <div class="message">',options={hash:{},data:data},!(stack1=(
...
helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this,helperMissing=helpers.helperMissing;function program4(depth0,data){var stack1,helper;return stack1=(helper=helpers.empty)||typeof(helper=depth0&&depth0.empty)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)}function program6(depth0,data,depth2){var stack1;return escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth2&&depth2.options)||!1===stack1?stack1:stack1.labels)||!1===stack1?stack1:stack1.empty)===functionType?stack1.apply(depth0):stack1)}
function program8(depth0,data){var stack1,helper;return stack1=(helper=helpers.available)||typeof(helper=depth0&&depth0.available)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)}function program10(depth0,data,depth2){var stack1;return escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth2&&depth2.options)||!1===stack1?stack1:stack1.labels)||!1===stack1?stack1:stack1.available)===functionType?stack1.apply(depth0):stack1)}function program12(depth0,data){var stack1,helper;return stack1=(helper=helpers.loading)||typeof(helper=depth0&&depth0.loading)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
escapeExpression(stack1)}function program14(depth0,data,depth2){var stack1;return escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth2&&depth2.options)||!1===stack1?stack1:stack1.labels)||!1===stack1?stack1:stack1.loading)===functionType?stack1.apply(depth0):stack1)}function program17(depth0,data){var stack1,buffer="";return buffer+='\n            <button class="btn-info small tool-',!(stack1=helpers.if.call(depth0,depth0&&depth0.id,{hash:{},inverse:self.program(20,program20,data),fn:self.program(18,program18,data),data:data}))&&0!==stack1||(buffer+=stack1),!(stack1=helpers.if.call(depth0,depth0&&depth0.massAction,{hash:{},inverse:self.noop,
fn:self.program(22,program22,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='"',!(stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:self.noop,fn:self.program(24,program24,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='>\n                <span class="icon-',!(stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:self.program(28,program28,data),fn:self.program(26,program26,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='"></span> ',!(stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:self.program(32,program32,data),fn:self.program(30,program30,data),data:data}))&&0!==stack1||(
buffer+=stack1),buffer+="\n            </button>\n        "}function program18(depth0,data){var stack1,helper;return stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)}function program20(depth0,data){var stack1;return escapeExpression(typeof(stack1=null==data||!1===data?data:data.key)===functionType?stack1.apply(depth0):stack1)}function program22(depth0,data){return" invisible"}function program24(depth0,data){var stack1,helper,buffer="";return buffer+=' title="',stack1=(helper=helpers.title)||typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{
hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'}function program26(depth0,data){var stack1,helper;return stack1=(helper=helpers.icon)||typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)}function program28(depth0,data){var stack1;return(stack1=helpers.if.call(depth0,depth0&&depth0.id,{hash:{},inverse:self.program(20,program20,data),fn:self.program(18,program18,data),data:data}))||0===stack1?stack1:""}function program30(depth0,data){var stack1,helper;return stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data
}):helper,escapeExpression(stack1)}function program32(depth0,data){var stack1;return(stack1=helpers.unless.call(depth0,depth0&&depth0.id,{hash:{},inverse:self.noop,fn:self.program(20,program20,data),data:data}))||0===stack1?stack1:""}function program34(depth0,data){return"\n                <col/>\n                "}function program41(depth0,data){return' class="actions"'}function program43(depth0,data){var stack1,helper,buffer="";return buffer+=' class="sortable" data-sort-by="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" ',!(
stack1=helpers.if.call(depth0,depth0&&depth0.sorttype,{hash:{},inverse:self.noop,fn:self.program(44,program44,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=' tabindex="0"'}function program44(depth0,data){var stack1,helper,buffer="";return buffer+='data-sort-type="',stack1=(helper=helpers.sorttype)||typeof(helper=depth0&&depth0.sorttype)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'}function program46(depth0,data){var stack1,helper,buffer="";return buffer+='\n                        <aside data-column="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(
depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" class="filter column\n                            ',!(stack1=helpers.if.call(depth0,depth0&&depth0.customFilter,{hash:{},inverse:self.program(49,program49,data),fn:self.program(47,program47,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                        </aside>\n                        "}function program47(depth0,data){var stack1,buffer="";return buffer+=' customInput" >\n                                ',!(stack1=typeof(stack1=null==(stack1=depth0&&depth0.customFilter)||!1===stack1?stack1:stack1.template)===functionType?stack1.apply(depth0):stack1)&&0!==stack1||(
buffer+=stack1),buffer+="\n                            "}function program49(depth0,data){var stack1,helper,buffer="";return buffer+=' ">\n                                <input type="text" value="" name="filter[',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+']" placeholder="'+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.filterable)||!1===stack1?stack1:stack1.placeholder)===functionType?stack1.apply(depth0):stack1)+'">\n                                <button class="icon-find" type="button"></button>\n                            '}
function program54(depth0,data){var stack1,helper,buffer="";return buffer+='\n                        <td class="checkboxes"><input type="checkbox" name="cb[',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+']" value="1" /></td>\n                        '}function program56(depth0,data,depth1){var stack1,buffer="";return buffer+="\n                            ",!(stack1=helpers.if.call(depth0,depth0&&depth0.type,{hash:{},inverse:self.programWithDepth(73,program73,data,depth1),fn:self.programWithDepth(57,program57,data,depth0,depth1),data:data})
)&&0!==stack1||(buffer+=stack1),buffer+="\n\n                        "}function program57(depth0,data,depth1,depth2){var stack1,helper,buffer="";return buffer+='\n                            <td class="actions ',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n                                ',!(stack1=helpers.each.call(depth0,depth1&&depth1.actions,{hash:{},inverse:self.noop,fn:self.programWithDepth(58,program58,data,depth2),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                            </td>\n                            "}
function program58(depth0,data,depth3){var stack1,buffer="";return buffer+="\n                                    ",!(stack1=helpers.if.call(depth0,depth0&&depth0.id,{hash:{},inverse:self.program(71,program71,data),fn:self.programWithDepth(59,program59,data,depth3),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n\n                                "}function program59(depth0,data,depth4){var stack1,buffer="";return buffer+="\n                                        ",!(stack1=helpers.with.call(depth0,depth4,{hash:{},inverse:self.noop,fn:self.programWithDepth(60,program60,data,depth0),data:data}))&&0!==stack1||(buffer+=stack1),
buffer+="\n                                    "}function program60(depth0,data,depth1){var stack1,buffer="";return buffer+="\n                                            ",!(stack1=helpers.unless.call(depth0,depth1&&depth1.hidden,{hash:{},inverse:self.noop,fn:self.programWithDepth(61,program61,data,depth1),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                                        "}function program61(depth0,data,depth2){var stack1,buffer="";return buffer+="\n                                                ",!(stack1=helpers.if.call(depth0,depth2&&depth2.disabled,{hash:{},inverse:self.programWithDepth(68,program68,data,depth2),
fn:self.programWithDepth(62,program62,data,depth2),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                                            "}function program62(depth0,data,depth3){var stack1,buffer="";return buffer+="\n                                                    ",!(stack1=helpers.with.call(depth0,depth3,{hash:{},inverse:self.noop,fn:self.program(63,program63,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                                                "}function program63(depth0,data){var stack1,helper,buffer="";return buffer+='\n                                <button class="btn-info small ',stack1=(helper=helpers.id
...
buffer+="</button>\n                                                    "}function program64(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)||typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '}function program66(depth0,data){var stack1,helper,buffer="";return buffer+=" ",stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)}function program68(depth0,data,depth3){var stack1,buffer=""
;return buffer+="\n                                                    ",!(stack1=helpers.with.call(depth0,depth3,{hash:{},inverse:self.noop,fn:self.program(69,program69,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                                                "}function program69(depth0,data){var stack1,helper,buffer="";return buffer+='\n                                <button class="btn-info small ',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"',!(stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:self.noop,
fn:self.program(24,program24,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=">",!(stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:self.noop,fn:self.program(64,program64,data),data:data}))&&0!==stack1||(buffer+=stack1),!(stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:self.noop,fn:self.program(66,program66,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="</button>\n                                                    "}function program71(depth0,data){var stack1,buffer="";return buffer+='\n                                <button class="btn-info small '+escapeExpression(typeof(
...
depth2){var stack1,helper,options,buffer="";return buffer+='\n                            <td class="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">',options={hash:{},data:data},stack1=(helper=helpers.property||depth0&&depth0.property)?helper.call(depth0,depth0&&depth0.id,depth2,options):helperMissing.call(depth0,"property",depth0&&depth0.id,depth2,options),options={hash:{},data:data},!(stack1=(helper=helpers.dompurify||depth0&&depth0.dompurify)?helper.call(depth0,stack1,options):helperMissing.call(depth0,"dompurify",stack1,options)
)&&0!==stack1||(buffer+=stack1),buffer+="</td>\n                            "}function program75(depth0,data,depth2){var stack1,buffer="";return buffer+='\n                        <td class="actions">\n                            ',!(stack1=helpers.each.call(depth0,null==(stack1=depth2&&depth2.options)||!1===stack1?stack1:stack1.actions,{hash:{},inverse:self.noop,fn:self.programWithDepth(76,program76,data,depth0),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n                        </td>\n                        "}function program76(depth0,data,depth1){var stack1,buffer="";return buffer+="\n                                ",!(stack1=helpers.if.call(
...
buffer+=stack1),buffer+="\n                </tr>\n            </thead>\n            <tbody>\n                ",!(stack1=helpers.each.call(depth0,null==(stack1=depth0&&depth0.dataset)||!1===stack1?stack1:stack1.data,{hash:{},inverse:self.noop,fn:self.programWithDepth(53,function(depth0,data,depth1){var stack1,helper,buffer="";return buffer+='\n                    <tr data-item-identifier="',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n                        ',!(stack1=helpers.if.call(depth0,null==(stack1=depth1&&depth1.options
)||!1===stack1?stack1:stack1.selectable,{hash:{},inverse:self.noop,fn:self.program(54,program54,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n\n                        ",!(stack1=helpers.each.call(depth0,null==(stack1=depth1&&depth1.options)||!1===stack1?stack1:stack1.model,{hash:{},inverse:self.noop,fn:self.programWithDepth(56,program56,data,depth0),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n\n                        ",!(stack1=helpers.if.call(depth0,null==(stack1=depth1&&depth1.options)||!1===stack1?stack1:stack1.actions,{hash:{},inverse:self.noop,fn:self.programWithDepth(75,program75,data,depth1),data:data}))&&0!==stack1||(
...
}))&&0!==stack1||(buffer+=stack1),buffer+='\n    </div>\n    <div class="datatable-pagination-bottom"></div>\n</div>'})}),define("tpl!ui/datatable/tpl/button",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<button class="btn-info small ',stack1=(helper=helpers.id)||typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"',!(
stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+=' title="',stack1=(helper=helpers.title)||typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=">",!(stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)||typeof(helper=depth0&&depth0.icon
)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '},data),data:data}))&&0!==stack1||(buffer+=stack1),!(stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:this.noop,fn:this.program(5,function(depth0,data){var stack1,helper;return stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="</button>"})}),define("tpl!ui/pagination/providers/tpl/pages",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,
partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="grid-row clearfix pagination">\n    <ul class="pages">\n        <li class="first-page"><span class="icon-fast-backward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"First page",options):helperMissing.call(depth0,"__","First page",options)))+'"></span></li>\n        <li class="previous"><span class="icon-backward" title="'+escapeExpression((options={hash:{},
data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Previous",options):helperMissing.call(depth0,"__","Previous",options)))+'"></span></li>\n        <li class="next"><span class="icon-forward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Next",options):helperMissing.call(depth0,"__","Next",options)))+'"></span></li>\n        <li class="last-page"><span class="icon-fast-forward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Last page",options):helperMissing.call(depth0,"__","Last page",options))
)+'"></span></li>\n    </ul>\n</div>'})}),define("tpl!ui/pagination/providers/tpl/pages/page",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<li class="page"><span>',buffer+=(0,this.escapeExpression)((helper=helpers.page)||"function"==typeof(helper=depth0&&depth0.page)?helper.call(depth0,{hash:{},data:data}):helper)+"</span></li>"})}),define("tpl!ui/pagination/providers/tpl/simple",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="grid-row clearfix pagination">\n    <div class="col-6">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Page",options):helperMissing.call(depth0,"__","Page",options)))+' <strong class="page">',buffer+=escapeExpression((helper=helpers.activePage)||"function"==typeof(helper=depth0&&depth0.activePage)?helper.call(depth0,{hash:{},data:data}):helper)+"</strong> "+escapeExpression((options={
hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"of",options):helperMissing.call(depth0,"__","of",options)))+' <span class="total">',buffer+=escapeExpression((helper=helpers.totalPages)||"function"==typeof(helper=depth0&&depth0.totalPages)?helper.call(depth0,{hash:{},data:data}):helper)+'</span></div>\n    <div class="col-6 txt-rgt">\n        <button class="btn-info small"><span class="icon-backward"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Previous",options):helperMissing.call(depth0,"__","Previous",options))
)+'</button>\n        <button class="btn-info small">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Next",options):helperMissing.call(depth0,"__","Next",options)))+'<span class="icon-forward r"></span></button>\n    </div>\n</div>'})}),define("layout/search",["jquery","lodash","i18n","layout/section","layout/actions","ui/feedback","ui/datatable"],function($,_,__,section,actionManager,feedback){"use strict";return{init:function(){var searchHandler,running=!1,$container=$(".action-bar .search-area"),$searchInput=$("input",$container),$searchBtn=$("button",$container);$container&&$container.length&&(
searchHandler=_.throttle(function(query){!1===running&&(running=!0,$.ajax({url:$container.data("url"),type:"POST",data:{query:query},dataType:"json"}).done(function(response){var data,$tableContainer;response&&response.result&&!0===response.result?(data=response,$tableContainer=$('<div class="flex-container-full"></div>'),section.updateContentBlock($tableContainer),$tableContainer.datatable({url:data.url,model:_.values(data.model),actions:{open:function(id){actionManager.trigger("refresh",{uri:id})}},params:{params:data.params,filters:data.filters,rows:20}})):feedback().warning(__("No results found"))}).complete(function(){running=!1}))},100),$searchBtn.off(
"click").on("click",function(e){e.preventDefault(),searchHandler($searchInput.val())}),$searchInput.off("keypress").on("keypress",function(e){var query=$searchInput.val();13===e.which&&(e.preventDefault(),searchHandler(query))}))}}}),function(definition,global){"use strict";"function"==typeof define?define("lib/store/idbstore",definition):"undefined"!=typeof module&&module.exports?module.exports=definition():global.IDBStore=definition()}(function(){"use strict";function defaultErrorHandler(error){throw error}function defaultSuccessHandler(){}function IDBStore(kwArgs,onStoreReady){for(var key in void 0===onStoreReady&&"function"==typeof kwArgs&&(
onStoreReady=kwArgs),"[object Object]"!=Object.prototype.toString.call(kwArgs)&&(kwArgs={}),defaults)this[key]=void 0!==kwArgs[key]?kwArgs[key]:defaults[key];this.dbName=this.storePrefix+this.storeName,this.dbVersion=parseInt(this.dbVersion,10)||1,onStoreReady&&(this.onStoreReady=onStoreReady);var env="object"==typeof window?window:self,availableImplementations=this.implementationPreference.filter(function(implName){return implName in env});this.implementation=availableImplementations[0],this.idb=env[this.implementation],this.keyRange=env.IDBKeyRange||env.webkitIDBKeyRange||env.mozIDBKeyRange,this.consts={READ_ONLY:"readonly",READ_WRITE:"readwrite",
VERSION_CHANGE:"versionchange",NEXT:"next",NEXT_NO_DUPLICATE:"nextunique",PREV:"prev",PREV_NO_DUPLICATE:"prevunique"},this.openDB()}var defaults={storeName:"Store",storePrefix:"IDBWrapper-",dbVersion:1,keyPath:"id",autoIncrement:!0,onStoreReady:function(){},onError:defaultErrorHandler,indexes:[],implementationPreference:["indexedDB","webkitIndexedDB","mozIndexedDB","shimIndexedDB"]},proto={constructor:IDBStore,version:"1.7.0",db:null,dbName:null,dbVersion:null,store:null,storeName:null,storePrefix:null,keyPath:null,autoIncrement:null,indexes:null,implementationPreference:null,implementation:"",onStoreReady:null,onError:null,_insertIdCount:0,openDB:function(
...
var possibleActions;_.isArray(exclude)||(exclude=[]),0<(possibleActions=_.filter(actions,function(action,name){return _.contains(nodeContext.context,action.context)&&!_.contains(exclude,name)})).length&&actionManager.exec(possibleActions[0],nodeContext)}function addClassToNode(node,clazz){node&&node.attributes&&(node.attributes.class=node.attributes.class||"",node.attributes.class.length?node.attributes.class=node.attributes.class+" "+clazz:node.attributes.class=clazz)}function getTreeData(response){var currentRights,treeData=response.tree||response;return response.permissions&&(currentRights=permissionsManager.getRights(),
